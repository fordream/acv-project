...
public class Vol3Osyougatsu extends BaseGameActivity implements IOnSceneTouchListener {
	...
	public static Sound OGG_A3_A_4_KACHI2, OGG_A3_A_4_SUZU2, OGG_A3_A_5_IYO, OGG_A3_A_5_KOMA1, OGG_A3_A_5_KOMA2, OGG_A3_A_5_KOMA3, OGG_A3_A_5_KOMA4, OGG_A3_A_5_KOMATEI, OGG_A3_A_5_KOMATEI2, OGG_A3_A_5_KOMATEI3, OGG_A3_A_5_KOMATEI4,
			OGG_A3_A_5_SPACE6, OGG_A3_A_6_GO, OGG_A3_A_6_KACHIN, OGG_A3_B_10_MOKIN, OGG_A3_B_10_NYUN, OGG_A3_B_11_HAKUSYU, OGG_A3_B_11_PON, OGG_A3_B_7_SYU2, OGG_A3_B_8_ASOBANAI, OGG_A3_B_8_NEZUMI, OGG_A3_B_8_SYUHUSUMA2, OGG_A3_B_8_WA4,
			OGG_A3_B_8_YUBINDESU3, OGG_A3_B_9A_ONIPANTS, OGG_A3_B_9A_POKA, OGG_A3_B_9B_DON, OGG_A3_B_9_DONPUSYU2, OGG_A3_C_12_AME_LONG, OGG_A3_C_12_AME_SHORT, OGG_A3_C_13_PYU2, OGG_A3_C_14A_KAMOME, OGG_A3_C_14B_POWAN, OGG_A3_C_14C_BOCYAN,
			OGG_A3_C_15A_SYUTA, OGG_A3_C_15B_UN, OGG_A3_C_16_CYAPA, OGG_A3_C_16_PYONBASYAN;
	...
	protected void loadKaraokeResources() {
		...
		mPartAScene = new Vol3OsyougatsuAScene(mTexturePackLoaderFromSource, getVertexBufferObjectManager(), getTextureManager());
		mPartBScene = new Vol3OsyougatsuBScene(mTexturePackLoaderFromSource, getVertexBufferObjectManager(), getTextureManager());
		mPartCScene = new Vol3OsyougatsuCScene(mTexturePackLoaderFromSource, getVertexBufferObjectManager(), getTextureManager());
	...
	protected void loadKaraokeScene() {
		...
		mGimicSprite[0] = new GimicSprite(244, tpGimic.getTexturePackTextureRegionLibrary().get(Vol3OsyougatsuResource.packer_gimic.A3_ABC_1_IPHONE_WADAIKO_ID), getVertexBufferObjectManager(),
				loadSoundResourceFromSD(Vol3OsyougatsuResource.A3_ABC_1_WADAIKO), GimicSprite.GIMIC_1);
		mGimicSprite[1] = new GimicSprite(436, tpGimic.getTexturePackTextureRegionLibrary().get(Vol3OsyougatsuResource.packer_gimic.A3_ABC_2_IPHONE_KOTO_ID), getVertexBufferObjectManager(),
				loadSoundResourceFromSD(Vol3OsyougatsuResource.A3_ABC_2_KOTO), GimicSprite.GIMIC_2);
		mGimicSprite[2] = new GimicSprite(612, tpGimic.getTexturePackTextureRegionLibrary().get(Vol3OsyougatsuResource.packer_gimic.A3_ABC_3_IPHONE_CHIKICHIN_ID), getVertexBufferObjectManager(),
				loadSoundResourceFromSD(Vol3OsyougatsuResource.A3_ABC_3_CHIKICHIN), GimicSprite.GIMIC_3);
	...
	class GimicSprite extends Sprite {
		...
		public GimicSprite(float pX, ITextureRegion pTextureRegion, VertexBufferObjectManager pVertexBufferObjectManager, final Sound pSound, int pGimic) {
		...
		private void onTouch() {
			...
			runOnUpdateThread(new Runnable() {
				...
				public void run() {
					...
					isTouchGimic = false;
					GimicSprite.this.registerEntityModifier(new SequenceEntityModifier(new ScaleModifier(0.35f, 1, 1.3f), new ScaleModifier(0.35f, 1.3f, 1f, new IEntityModifierListener() {
