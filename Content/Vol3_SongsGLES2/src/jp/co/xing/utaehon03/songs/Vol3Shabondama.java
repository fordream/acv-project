...
public class Vol3Shabondama extends BaseGameFragment implements IOnSceneTouchListener {
	...
	public synchronized void onPauseGame() {
		...
		if(pAnimatedSpritePandaScence.isVisible()==true&&pAnimatedSpritePandaScence!=null){
			pAnimatedSpritePandaScence.setVisible(false);
			pAnimatedSpritePandaScence.setPosition(pAnimatedSpritePandaScence.getmXFirst(), 
					pAnimatedSpritePandaScence.getmYFirst());
