...
public class Vol3Guchokipa extends BaseGameActivity implements
		IOnSceneTouchListener {
	private static final String TAG = "LOG_GUCHOKIPA";

	private int x = 0, y = 0, current = 1, case1 = 0, case2 = 0, case4 = 0, case5 = 0, case6 = 0;
	...
	private boolean finishNeko, finishKani, finishUsagi, finishNail, finishPasta, finishKuma, finishJisan,
	finishKurage, finishEgg, finishHeri, finishOhana, finishHanabi, finishCyou;

	private TexturePack ttpGuchokipa1, ttpGuchokipa2, ttpGuchokipa3,
			ttpGuchokipa4, ttpGuchokipa5, ttpGuchokipa6, ttpGuchokipa7,
			ttpGuchokipa8, ttpGuchokipa9, ttpGuchokipa10, ttpGuchokipa11,
			ttpGuchokipa12, ttpGuchokipa13, ttpGuchokipa14, ttpGuchokipa15,
			ttpGuchokipa16, ttpGuchokipa17, ttpGuchokipa18, ttpGuchokipa19,
			ttpGuchokipa20, ttpGuchokipa21, ttpGuchokipa22, ttpGuchokipa23,
			ttpGuchokipa24, ttpGuchokipa25, ttpGuchokipa26, ttpGuchokipa27,
			ttpGuchokipa28, ttpGuchokipa29, ttpGuchokipa30, ttpGuchokipa31;

	private TexturePackTextureRegionLibrary ttpLibGuchokipa26,
			ttpLibGuchokipa27, ttpLibGuchokipa30, ttpLibGuchokipa31;

	private AnimatedSprite animOnePiero, animSmoke, animOnePieroSize,
			animhoneneko4112, animhoneneko4134, animhonekani4212,
			animhonekani4234, anim4and51123, anim4and5145, anim4and5212,
			anim4and5265, anim4and5243, anim4and6112, anim4and61345,
			animhonekuma12, animhonekuma34, animhonejisan12, animhonejisan34,
			anim5and6112, anim5and6134, anim5and6212, anim5and63123,
			anim5and63456, animhonehana1123, animhonehana145, animhonehana212,
			animhonehana2345, animhonecyou112, animhonecyou1345;

	private TiledTextureRegion tttrOnePiero, tttrSmoke, tttrOnePieroSize,
			tttrhoneneko4112, tttrhoneneko4134, tttrhonekani4212,
			tttrhonekani4234, tttr4and51123, tttr4and5145, tttr4and5212,
			tttr4and5265, tttr4and5243, tttr4and6112, tttr4and61345,
			tttrhonekuma12, tttrhonekuma34, tttrhonejisan12, tttrhonejisan34,
			tttr5and6112, tttr5and6134, tttr5and6212, tttr5and63123,
			tttr5and63456, tttrhonehana1123, tttrhonehana145, tttrhonehana212,
			tttrhonehana2345, tttrhonecyou112, tttrhonecyou1345;

	private TexturePackLoaderFromSource mTexturePackLoaderFromSource;

	private TextureRegion ttrBackground, ttrOne, ttrTwo, ttrThree, ttrOnePiOne,
			ttrTwoPiOne, ttrThreePiOne, ttr4and527, ttr5and623, ttr5and624,
			ttr5and625;

	private Sprite sOne, sTwo, sThree, sOnePiOne, sTwoPiOne, sThreePiOne,
			sONE1, sONE2, sTWO1, sTWO2, sTHREE1, sTHREE2, s4and527, s5and623,
			s5and624, s5and625;

	private Sound mp3chyu7, mp3katatsumuri, mp3kui, mp3nyu, mp3usagi2, mp3supa3, 
		mp3gu, mp3kani2, mp3kasa, mp3neko, mp3neko_voice, mp3bomi, mp3cyoki, mp3kobujisan,
		mp3kuma, mp3ohana, mp3pa, mp3arere, mp3boyon, mp3oyaoya, mp3chou, mp3hanabi, 
		mp3kemuri, mp3kurage2,mp3awaboko, mp3heri, mp3heri_voice, mp3kira5,
		mp3medamayaki, mp3medamayaki3, mp3pachidone, mp3syararan, mp3syusyu;
	...
	protected void loadKaraokeResources() {
		...
		// Texture
		// Background
		this.ttrBackground = ttpLibGuchokipa30
				.get(Vol3GuchokipaResource.A1_9_IPHONE_HAIKEI_ID);

		// OnePiero
		this.tttrOnePiero = getTiledTextureFromPacker(ttpGuchokipa26,
				Vol3GuchokipaResource.A1_7_4_IPHONE_PIERO_ID,
				Vol3GuchokipaResource.A1_7_5_IPHONE_PIERO_ID);
		this.ttrOnePiOne = ttpLibGuchokipa26
				.get(Vol3GuchokipaResource.A1_7_2_IPHONE_PIERO_ID);

		this.ttrTwoPiOne = ttpLibGuchokipa26
				.get(Vol3GuchokipaResource.A1_7_1_IPHONE_PIERO_ID);

		this.ttrThreePiOne = ttpLibGuchokipa26
				.get(Vol3GuchokipaResource.A1_7_3_IPHONE_PIERO_ID);

		Log.d(TAG, "loadKaraokeResources: end");

		// One - Two - Three
		this.ttrOne = ttpLibGuchokipa27
				.get(Vol3GuchokipaResource.A1_4_IPHONE_K_ID);
		this.ttrTwo = ttpLibGuchokipa27
				.get(Vol3GuchokipaResource.A1_5_IPHONE_G_ID);
		this.ttrThree = ttpLibGuchokipa27
				.get(Vol3GuchokipaResource.A1_6_IPHONE_P_ID);

		// OnePiero Size
		this.tttrOnePieroSize = getTiledTextureFromPacker(ttpGuchokipa28,
				Vol3GuchokipaResource.A1_7_6_IPHONE_PIERO_ID,
				Vol3GuchokipaResource.A1_7_7_IPHONE_PIERO_ID);

		// Smoke
		this.tttrSmoke = getTiledTextureFromPacker(ttpGuchokipa29,
				Vol3GuchokipaResource.A1_8_1_IPHONE_KEMURI_ID,
				Vol3GuchokipaResource.A1_8_2_IPHONE_KEMURI_ID,
				Vol3GuchokipaResource.A1_8_3_IPHONE_KEMURI_ID);

		// Honeneko4112
		this.tttrhoneneko4112 = getTiledTextureFromPacker(ttpGuchokipa1,
				Vol3GuchokipaResource.A1_4_1_1_IPHONE_NEKO_ID,
				Vol3GuchokipaResource.A1_4_1_2_IPHONE_NEKO_ID);
		
		// Honeneko4134
		this.tttrhoneneko4134 = getTiledTextureFromPacker(ttpGuchokipa2,
				Vol3GuchokipaResource.A1_4_1_3_IPHONE_NEKO_ID,
				Vol3GuchokipaResource.A1_4_1_4_IPHONE_NEKO_ID);
		
		// Honekani 4212
		this.tttrhonekani4212 = getTiledTextureFromPacker(ttpGuchokipa3,
				Vol3GuchokipaResource.A1_4_2_1_IPHONE_KANI_ID,
				Vol3GuchokipaResource.A1_4_2_2_IPHONE_KANI_ID);
		
		// Honekani 4234
		this.tttrhonekani4234 = getTiledTextureFromPacker(ttpGuchokipa4,
				Vol3GuchokipaResource.A1_4_2_3_IPHONE_KANI_ID,
				Vol3GuchokipaResource.A1_4_2_4_IPHONE_KANI_ID);

		// 4and51123
		this.tttr4and51123 = getTiledTextureFromPacker(ttpGuchokipa5,
				Vol3GuchokipaResource.A1_4AND5_1_1_IPHONE_USAGI_ID,
				Vol3GuchokipaResource.A1_4AND5_1_2_IPHONE_USAGI_ID,
				Vol3GuchokipaResource.A1_4AND5_1_3_IPHONE_USAGI_ID);
		
		// 4and5145
		this.tttr4and5145 = getTiledTextureFromPacker(ttpGuchokipa6,
				Vol3GuchokipaResource.A1_4AND5_1_4_IPHONE_USAGI_ID,
				Vol3GuchokipaResource.A1_4AND5_1_5_IPHONE_USAGI_ID);

		// 4and5212
		this.tttr4and5212 = getTiledTextureFromPacker(ttpGuchokipa7,
				Vol3GuchokipaResource.A1_4AND5_2_1_IPHONE_SNAIL_ID,
				Vol3GuchokipaResource.A1_4AND5_2_2_IPHONE_SNAIL_ID);
		
		// 4and5265
		this.tttr4and5265 = getTiledTextureFromPacker(ttpGuchokipa9,
				Vol3GuchokipaResource.A1_4AND5_2_6_IPHONE_SNAIL_ID,
				Vol3GuchokipaResource.A1_4AND5_2_5_IPHONE_SNAIL_ID);
		
		// 4and5243
		this.tttr4and5243 = getTiledTextureFromPacker(ttpGuchokipa8,
				Vol3GuchokipaResource.A1_4AND5_2_4_IPHONE_SNAIL_ID,
				Vol3GuchokipaResource.A1_4AND5_2_3_IPHONE_SNAIL_ID);
		
		// 4and5227
		this.ttr4and527 = ttpLibGuchokipa31
				.get(Vol3GuchokipaResource.A1_4AND5_2_7_IPHONE_SNAIL_ID);

		// 4and6112
		this.tttr4and6112 = getTiledTextureFromPacker(ttpGuchokipa10,
				Vol3GuchokipaResource.A1_4AND6_1_1_IPHONE_PASTA_ID,
				Vol3GuchokipaResource.A1_4AND6_1_2_IPHONE_PASTA_ID);

		// 4and61345
		this.tttr4and61345 = getTiledTextureFromPacker(ttpGuchokipa11,
				Vol3GuchokipaResource.A1_4AND6_1_3_IPHONE_PASTA_ID,
				Vol3GuchokipaResource.A1_4AND6_1_4_IPHONE_PASTA_ID,
				Vol3GuchokipaResource.A1_4AND6_1_5_IPHONE_PASTA_ID);

		// Honakuma12
		this.tttrhonekuma12 = getTiledTextureFromPacker(ttpGuchokipa12,
				Vol3GuchokipaResource.A1_5_1_1_IPHONE_KUMA_ID,
				Vol3GuchokipaResource.A1_5_1_2_IPHONE_KUMA_ID);

		// Honekuma34
		this.tttrhonekuma34 = getTiledTextureFromPacker(ttpGuchokipa13,
				Vol3GuchokipaResource.A1_5_1_3_IPHONE_KUMA_ID,
				Vol3GuchokipaResource.A1_5_1_4_IPHONE_KUMA_ID);

		// Honejisan12
		this.tttrhonejisan12 = getTiledTextureFromPacker(ttpGuchokipa14,
				Vol3GuchokipaResource.A1_5_2_1_IPHONE_JISAN_ID,
				Vol3GuchokipaResource.A1_5_2_2_IPHONE_JISAN_ID);

		// Honejisan34
		this.tttrhonejisan34 = getTiledTextureFromPacker(ttpGuchokipa15,
				Vol3GuchokipaResource.A1_5_2_3_IPHONE_JISAN_ID,
				Vol3GuchokipaResource.A1_5_2_4_IPHONE_JISAN_ID);

		// 5and6112
		this.tttr5and6112 = getTiledTextureFromPacker(ttpGuchokipa16,
				Vol3GuchokipaResource.A1_5AND6_1_1_IPHONE_KURAGE_ID,
				Vol3GuchokipaResource.A1_5AND6_1_2_IPHONE_KURAGE_ID);

		// 5and6134
		this.tttr5and6134 = getTiledTextureFromPacker(ttpGuchokipa17,
				Vol3GuchokipaResource.A1_5AND6_1_3_IPHONE_KURAGE_ID,
				Vol3GuchokipaResource.A1_5AND6_1_4_IPHONE_KURAGE_ID);

		// 5and6212
		this.tttr5and6212 = getTiledTextureFromPacker(ttpGuchokipa18,
				Vol3GuchokipaResource.A1_5AND6_2_1_IPHONE_MEDAMA_ID,
				Vol3GuchokipaResource.A1_5AND6_2_2_IPHONE_MEDAMA_ID);

		// 5and623
		this.ttr5and623 = ttpLibGuchokipa27
				.get(Vol3GuchokipaResource.A1_5AND6_2_3_IPHONE_MEDAMA_ID);

		// 5and624
		this.ttr5and624 = ttpLibGuchokipa27
				.get(Vol3GuchokipaResource.A1_5AND6_2_4_IPHONE_MEDAMA_ID);

		// 5and625
		this.ttr5and625 = ttpLibGuchokipa27
				.get(Vol3GuchokipaResource.A1_5AND6_2_5_IPHONE_MEDAMA_ID);

		// 5and63123
		this.tttr5and63123 = getTiledTextureFromPacker(ttpGuchokipa19,
				Vol3GuchokipaResource.A1_5AND6_3_1_IPHONE_HERI_ID,
				Vol3GuchokipaResource.A1_5AND6_3_2_IPHONE_HERI_ID,
				Vol3GuchokipaResource.A1_5AND6_3_3_IPHONE_HERI_ID);

		// 5and63456
		this.tttr5and63456 = getTiledTextureFromPacker(ttpGuchokipa20,
				Vol3GuchokipaResource.A1_5AND6_3_4_IPHONE_HERI_ID,
				Vol3GuchokipaResource.A1_5AND6_3_5_IPHONE_HERI_ID,
				Vol3GuchokipaResource.A1_5AND6_3_6_IPHONE_HERI_ID);

		// honahana1123
		this.tttrhonehana1123 = getTiledTextureFromPacker(ttpGuchokipa21,
				Vol3GuchokipaResource.A1_6_1_1_IPHONE_HANA_ID,
				Vol3GuchokipaResource.A1_6_1_2_IPHONE_HANA_ID,
				Vol3GuchokipaResource.A1_6_1_3_IPHONE_HANA_ID);

		// honehana145
		this.tttrhonehana145 = getTiledTextureFromPacker(ttpGuchokipa22,
				Vol3GuchokipaResource.A1_6_1_4_IPHONE_HANA_ID,
				Vol3GuchokipaResource.A1_6_1_5_IPHONE_HANA_ID);

		// honehana212
		this.tttrhonehana212 = getTiledTextureFromPacker(ttpGuchokipa31,
				Vol3GuchokipaResource.A1_6_2_1_IPHONE_HANABI_ID,
				Vol3GuchokipaResource.A1_6_2_2_IPHONE_HANABI_ID);

		// honehana2345
		this.tttrhonehana2345 = getTiledTextureFromPacker(ttpGuchokipa23,
				Vol3GuchokipaResource.A1_6_2_3_IPHONE_HANABI_ID,
				Vol3GuchokipaResource.A1_6_2_4_IPHONE_HANABI_ID,
				Vol3GuchokipaResource.A1_6_2_5_IPHONE_HANABI_ID);

		// honecyou112
		this.tttrhonecyou112 = getTiledTextureFromPacker(ttpGuchokipa24,
				Vol3GuchokipaResource.A1_6_3_1_IPHONE_CYOU_ID,
				Vol3GuchokipaResource.A1_6_3_2_IPHONE_CYOU_ID);

		// honecyou1345
		this.tttrhonecyou1345 = getTiledTextureFromPacker(ttpGuchokipa25,
				Vol3GuchokipaResource.A1_6_3_3_IPHONE_CYOU_ID,
				Vol3GuchokipaResource.A1_6_3_4_IPHONE_CYOU_ID,
				Vol3GuchokipaResource.A1_6_3_5_IPHONE_CYOU_ID);
	...
	protected void loadKaraokeScene() {
		...
		this.mScene.setBackground(new SpriteBackground(new Sprite(0, 0,
				CAMERA_WIDTH, CAMERA_HEIGHT, this.ttrBackground, this
						.getVertexBufferObjectManager())));
		// One Piero
		this.animOnePiero = new AnimatedSprite(680, 36, tttrOnePiero,
		...
		addGimmicsButton(mScene, Vol3GuchokipaResource.SOUND_GIMMIC_GUCHOKIPA,
				Vol3GuchokipaResource.IMAGE_GIMMIC_GUCHOKIPA, ttpLibGuchokipa27);
	...
	public void onCreateResources() {
		...
		mTexturePackLoaderFromSource = new TexturePackLoaderFromSource(
				this.getTextureManager(), pAssetManager, "guchokipa/gfx/");
	...
	public void ScaleSprite() {
		LoopEntityModifier LoopScale = new LoopEntityModifier(
				new SequenceEntityModifier(
					new ScaleModifier(0.8f, 1.0f, 1.1f),
					new ScaleModifier(0.2f, 1.1f, 1.0f),
					new DelayModifier(2.0f)), -1);
	...
	public void Gimmic() {
		if (isgimmic) {
			...
			if (checkgm) {
				...
				animOnePieroSize.registerEntityModifier(new SequenceEntityModifier(
			...
			if (checkmg) {
				...
				animOnePiero.setVisible(false);
				sTwoPiOne.setVisible(true);
				sTwoPiOne.registerEntityModifier(new SequenceEntityModifier(
					new MoveYModifier(0.5f, 36.0f, 10.0f),
					new DelayModifier(0.1f, new IEntityModifierListener() {
						...
						@Override
						public void onModifierFinished(IModifier<IEntity> arg0, IEntity arg1) {
							animOnePiero.registerEntityModifier(new SequenceEntityModifier(
								new MoveYModifier(0.5f, 10.0f,
										36.0f),
								new DelayModifier(0.1f,new IEntityModifierListener() {
											@Override
				...
				animSecond.animate(pDurationss, pFrames, 0,new IAnimationListener() {
					...
					public void onAnimationFinished(AnimatedSprite arg0) {
						...
						animThird.animate(pDurationst, pFramet, 1,new IAnimationListener() {
							...
							public void onAnimationFinished(AnimatedSprite arg0) {
								animThird.registerEntityModifier(new SequenceEntityModifier(
									new MoveXModifier(0.3f,204.0f,170.0f),
									new MoveXModifier(0.3f,170.0f,204.0f)));
	...
	//Action Katatsu
	public void actionKatatsu(final AnimatedSprite animFirst, final AnimatedSprite animSecond, final AnimatedSprite animThird,
			final AnimatedSprite AnimFour, final Sprite sEye) {
		animFirst.setVisible(true);
							...
							public void onAnimationFinished(AnimatedSprite arg0) {
								...
								AnimFour.registerEntityModifier(new DelayModifier(0.45f,new IEntityModifierListener() {
									...
									public void onModifierFinished(IModifier<IEntity> arg0,IEntity arg1) {
										...
										mp3kui.play();
										sEye.registerEntityModifier(new SequenceEntityModifier(
											new ScaleModifier(0.8f, 1.0f, 1.3f),
											new LoopEntityModifier(
												new SequenceEntityModifier(
													new RotationAtModifier(0.4f, 0, 12, 60.5f, 106.0f),
													new RotationAtModifier(0.4f, 12, -12, 60.5f, 106.0f),
													new RotationAtModifier(0.2f, -12, 0, 60.5f, 106.0f)), 2)));
										...
										AnimFour.registerEntityModifier(new DelayModifier(2.5f, new IEntityModifierListener() {
											...
											@Override
											public void onModifierFinished(IModifier<IEntity> arg0,IEntity arg1) {
												AnimFour.registerEntityModifier(new SequenceEntityModifier(
													new DelayModifier(0.5f),
													new DelayModifier(1.5f,new IEntityModifierListener() {
					...
					public void onAnimationFinished(AnimatedSprite arg0) {
						...
						egg.registerEntityModifier(new SequenceEntityModifier(
							...
							new ParallelEntityModifier(
								new MoveYModifier(0.75f, 146.0f,-50.0f),
								new RotationAtModifier(0.3f, 0,16, 170.0f, 120.0f)),
								
							new ParallelEntityModifier(
								new MoveYModifier(0.75f, -50.0f,145.0f),
								new DelayModifier(0.2f,new IEntityModifierListener() {
									...
									public void onModifierFinished(IModifier<IEntity> arg0,IEntity arg1) {
										...
										finish.registerEntityModifier(new SequenceEntityModifier(
					...
					public void onAnimationFinished(AnimatedSprite arg0) {
						...
						animThird.animate(pDurationst, pFramet, 0, new IAnimationListener() {
							...
							public void onAnimationFinished(AnimatedSprite arg0) {
								...
								animThird.registerEntityModifier( new SequenceEntityModifier(
										new SequenceEntityModifier(
											new ScaleModifier(0.35f,1.0f,1.3f),
											new ScaleModifier(0.35f,1.3f,0.8f),
											new ScaleModifier(0.35f,0.8f,1.0f)),
										new DelayModifier(0.5f),
										new DelayModifier(1.5f,new IEntityModifierListener() {
											@Override
											public void onModifierStarted(IModifier<IEntity> arg0,IEntity arg1) {
	...
	public synchronized void onResumeGame() {
		...
		ScaleSprite();
		setBoolean(false, finishNeko, finishKani, finishUsagi, finishNail, finishPasta, finishKuma,
			finishJisan, finishKurage, finishEgg, finishHeri, finishOhana, finishHanabi, finishCyou);
