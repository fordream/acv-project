...
public class Vol3Happybirthday extends BaseGameFragment implements
	...
	private void onCreateViewScroll() {
		...
		for (int i = 0; i < Vol3HappybirthdayResouce.resourceItem.length; i++) {
			...
			imgView[i] = new ImageView(getActivity());
