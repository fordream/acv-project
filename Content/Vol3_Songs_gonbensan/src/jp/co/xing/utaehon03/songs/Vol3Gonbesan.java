...
public class Vol3Gonbesan extends BaseGameActivity implements IOnSceneTouchListener, IModifierListener<IEntity> {
	...
	private TextureRegion ttrBackground1, ttrBackground2, ttrBackground3, ttrSuisya, ttrKaki, ttrBanana, ttrMonkey1, ttrMonkey2, ttrMonkey3;
	private Sprite sBackground1, sBackground2, sBackground3, sSuisya, sKaki, sBanana, sMonkey1, sMonkey2, sMonkey3;
	...
	private SequenceEntityModifier seDogModifier, seMonkey1Modifier, seMonkey2Modifier, seMonkey3Modifier;
	 ...
	 * Sounds
	 */
	private Sound E00018_QUESTION, E00019_LAUGH, E00067_DADADA, E00068_MONKEY, E00069_DOG, E00070_POMI;
	...
	public void onCreateResources() {
		...
		mTexturePackLoaderFromSource = new TexturePackLoaderFromSource(getTextureManager(), pAssetManager, "gonbesan/gfx/");
	...
	protected void loadKaraokeResources() {
		...
		this.tttrRiver = getTiledTextureFromPacker(ttpGonbesan, Vol3GonbesanResouce.A3_13_1_IPHONE3G_RIVER_ID, Vol3GonbesanResouce.A3_13_2_IPHONE3G_RIVER_ID);
		...
		this.tttrDog = getTiledTextureFromPacker(ttpGonbesan, Vol3GonbesanResouce.A3_08_1_IPHONE3G_E00069_DOG_ID, Vol3GonbesanResouce.A3_08_2_IPHONE3G_E00069_DOG_ID);

		this.tttrPerson = getTiledTextureFromPacker(ttpGonbesan, Vol3GonbesanResouce.A3_04_1_IPHONE3G_E00019_LAUGH_ID, Vol3GonbesanResouce.A3_04_2_IPHONE3G_E00019_LAUGH_ID, Vol3GonbesanResouce.A3_07_1_IPHONE3G_E00017_CRY_ID,
		...
		for (int i = 0; i < tttrDadada.length; i++) {
			this.tttrDadada[i] = getTiledTextureFromPacker(ttpGonbesan, Vol3GonbesanResouce.A3_09_1_IPHONE3G_E00067_DADADA_ID, Vol3GonbesanResouce.A3_09_2_IPHONE3G_E00067_DADADA_ID);
		}
	...
	protected void loadKaraokeScene() {
		...
		addGimmicsButton(this.mScene, Vol3GonbesanResouce.SOUND_GIMMIC, Vol3GonbesanResouce.IMAGE_GIMMIC, ttpLibGonbesan);
	...
	public boolean onSceneTouchEvent(Scene pScene, TouchEvent pSceneTouchEvent) {
		...
		if (pSceneTouchEvent.isActionDown()) {
			...
			// }
			// }
			if (checkContains(sBanana, 2, 2, 52, 36, pX, pY) || checkContains(sBackground2, 392, 74, 542, 148, pX, pY)) {
				if (istouchBanana) {
					istouchBanana = false;
					touchBanana();
				}
	...
	private void touchDadada(final int index) {
		...
		final Path pDadada = new Path(6).to(aniDadada[index].getX(), aniDadada[index].getY()).to(622, sBackground2.getY() + 100).to(462, sBackground2.getY() + 38).to(326, sBackground2.getY() + 84).to(160, sBackground2.getY())
	...
	private void touchBanana() {
		...
		switch (i) {
		case 0:
			sMonkey1.registerEntityModifier(seMonkey1Modifier = new SequenceEntityModifier(new MoveYModifier(0.5f, sMonkey1.getY(), sMonkey1.getY() - 160), new MoveYModifier(0.5f, sMonkey1.getY() - 160, sMonkey1.getY())));
			sMonkey2.registerEntityModifier(seMonkey2Modifier = new SequenceEntityModifier(new MoveYModifier(0.5f, sMonkey2.getY(), sMonkey2.getY() - 160), new MoveYModifier(0.5f, sMonkey2.getY() - 160, sMonkey2.getY())));
		...
		case 2:
			sMonkey2.registerEntityModifier(seMonkey2Modifier = new SequenceEntityModifier(new MoveYModifier(0.5f, sMonkey2.getY(), sMonkey2.getY() - 160), new MoveYModifier(0.5f, sMonkey2.getY() - 160, sMonkey2.getY())));
			sMonkey3.registerEntityModifier(seMonkey3Modifier = new SequenceEntityModifier(new MoveYModifier(0.5f, sMonkey3.getY(), sMonkey3.getY() - 160), new MoveYModifier(0.5f, sMonkey3.getY() - 160, sMonkey3.getY())));
			seMonkey2Modifier.addModifierListener(this);
	...
	private void touchKaki() {
		...
		sKaki.registerEntityModifier(moveKakiModifier = new MoveModifier(3.0f, sKaki.getX(), -300, sKaki.getY(), 780));
	...
	private void touchDog() {
		...
		aniDog.registerEntityModifier(seDogModifier = new SequenceEntityModifier(new RotationModifier(0.4f, 0.0f, 15.0f), new RotationModifier(0.4f, 15.0f, 0.0f)));
	...
	private void moveKarasu() {
		...
		aniKarasu.registerEntityModifier(moveKarasuModifier = new MoveXModifier(duration, aniKarasu.getX(), 980));
	...
	private void moveSuisya() {
		Log.e("eCommon", "14");
		sSuisya.registerEntityModifier(new LoopEntityModifier(new RotationModifier(8.0f, 0.0f, 360.0f, EaseLinear.getInstance())));
		return;
	}
	...
	public void onModifierFinished(IModifier<IEntity> pModifier, IEntity pItem) {
		...
		if (pModifier.equals(seMonkey1Modifier) || pModifier.equals(seMonkey2Modifier) || pModifier.equals(seMonkey3Modifier)) {
			istouchBanana = true;
		}
	}
