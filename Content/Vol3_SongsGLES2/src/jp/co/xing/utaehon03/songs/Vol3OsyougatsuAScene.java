...
public class Vol3OsyougatsuAScene extends Vol3OsyougatsuScene {
	...
	private static final float POINTER_CUBIC_SLOT[][] = new float[][] { { 150, 260 }, { 550, 260 } };
	...
	private static final float POINTER_FACE[][] = new float[][] { { 73, 73, 241, 604, 904, 1083, 1083, 809, 755, 454, 210, 73 }, { 242, 388, 474, 528, 473, 379, 253, 284, 116, 110, 167, 242 } };

	private static final String CUBIC_BODYNAME[] = new String[] { "a3_6a_1_iphone_koma", "a3_6b_1_iphone_koma", "a3_6c_1_iphone_koma", "a3_6b_1_iphone_koma" };

	public Vol3OsyougatsuAScene(final TexturePackLoaderFromSource pTexturePackLoaderFromSource, VertexBufferObjectManager pVertexBufferObjectManager, final TextureManager pTextureManager) {
	...
	private void loadTexture() {
		...
		bitmapTexture[0] = new BitmapTextureAtlas(mTextureManager, 2, 2, TextureOptions.BILINEAR_PREMULTIPLYALPHA);
		bitmapTexture[1] = new BitmapTextureAtlas(mTextureManager, 2, 2, TextureOptions.BILINEAR_PREMULTIPLYALPHA);
		...
		mBackGroundTextureRegion = tpBackGround.getTexturePackTextureRegionLibrary().get(Vol3OsyougatsuResource.packer_parta_4.A3_7_IPHONE_HAIKEI_ID);

		mSuzuTiledTexTure = getTiledTextureFromPacker(tpOne, Vol3OsyougatsuResource.packer_parta_1.A3_4_1_IPHONE_SUZU_ID, Vol3OsyougatsuResource.packer_parta_1.A3_4_2_IPHONE_SUZU_ID, Vol3OsyougatsuResource.packer_parta_1.A3_4_3_IPHONE_SUZU_ID);

		mShishiTiledTexTure = getTiledTextureFromPacker(tpThree, Vol3OsyougatsuResource.packer_parta_3.A3_4_4_IPHONE_SHISHI_ID, Vol3OsyougatsuResource.packer_parta_3.A3_4_5_IPHONE_SHISHI_ID);

		mCubicStartTiledTexture[CUBIC_ORANGE] = getTiledTextureFromPacker(tpTwo, Vol3OsyougatsuResource.packer_parta_2.A3_6A_1_IPHONE_KOMA_ID, Vol3OsyougatsuResource.packer_parta_2.A3_6A_2_IPHONE_KOMA_ID,
				Vol3OsyougatsuResource.packer_parta_2.A3_6A_3_IPHONE_KOMA_ID);
		mCubicStartTiledTexture[CUBIC_BLUE] = getTiledTextureFromPacker(tpTwo, Vol3OsyougatsuResource.packer_parta_2.A3_6B_1_IPHONE_KOMA_ID, Vol3OsyougatsuResource.packer_parta_2.A3_6B_2_IPHONE_KOMA_ID,
				Vol3OsyougatsuResource.packer_parta_2.A3_6B_3_IPHONE_KOMA_ID);
		mCubicStartTiledTexture[CUBIC_GREEN] = getTiledTextureFromPacker(tpThree, Vol3OsyougatsuResource.packer_parta_3.A3_6C_1_IPHONE_KOMA_ID, Vol3OsyougatsuResource.packer_parta_3.A3_6C_2_IPHONE_KOMA_ID,
				Vol3OsyougatsuResource.packer_parta_3.A3_6C_3_IPHONE_KOMA_ID);
		mCubicStartTiledTexture[CUBIC_YELLOW] = getTiledTextureFromPacker(tpThree, Vol3OsyougatsuResource.packer_parta_3.A3_6D_1_IPHONE_KOMA_ID, Vol3OsyougatsuResource.packer_parta_3.A3_6D_2_IPHONE_KOMA_ID,
				Vol3OsyougatsuResource.packer_parta_3.A3_6D_3_IPHONE_KOMA_ID);

		mCubicTurnTiledTexture[CUBIC_ORANGE] = getTiledTextureFromPacker(tpOne, Vol3OsyougatsuResource.packer_parta_1.A3_6A_4_IPHONE_KOMA_ID, Vol3OsyougatsuResource.packer_parta_1.A3_6A_5_IPHONE_KOMA_ID,
				Vol3OsyougatsuResource.packer_parta_1.A3_6A_6_IPHONE_KOMA_ID, Vol3OsyougatsuResource.packer_parta_1.A3_6A_7_IPHONE_KOMA_ID, Vol3OsyougatsuResource.packer_parta_1.A3_6A_8_IPHONE_KOMA_ID,
				Vol3OsyougatsuResource.packer_parta_1.A3_6A_9_IPHONE_KOMA_ID);

		mCubicTurnTiledTexture[CUBIC_BLUE] = getTiledTextureFromPacker(tpOne, Vol3OsyougatsuResource.packer_parta_1.A3_6B_4_IPHONE_KOMA_ID, Vol3OsyougatsuResource.packer_parta_1.A3_6B_5_IPHONE_KOMA_ID,
				Vol3OsyougatsuResource.packer_parta_1.A3_6B_6_IPHONE_KOMA_ID, Vol3OsyougatsuResource.packer_parta_1.A3_6B_7_IPHONE_KOMA_ID, Vol3OsyougatsuResource.packer_parta_1.A3_6B_8_IPHONE_KOMA_ID,
				Vol3OsyougatsuResource.packer_parta_1.A3_6B_9_IPHONE_KOMA_ID);

		mCubicTurnTiledTexture[CUBIC_GREEN] = getTiledTextureFromPacker(tpOne, Vol3OsyougatsuResource.packer_parta_1.A3_6C_4_IPHONE_KOMA_ID, Vol3OsyougatsuResource.packer_parta_1.A3_6C_5_IPHONE_KOMA_ID,
				Vol3OsyougatsuResource.packer_parta_1.A3_6C_6_IPHONE_KOMA_ID, Vol3OsyougatsuResource.packer_parta_1.A3_6C_7_IPHONE_KOMA_ID, Vol3OsyougatsuResource.packer_parta_1.A3_6C_8_IPHONE_KOMA_ID,
				Vol3OsyougatsuResource.packer_parta_1.A3_6C_9_IPHONE_KOMA_ID);

		mCubicTurnTiledTexture[CUBIC_YELLOW] = getTiledTextureFromPacker(tpOne, Vol3OsyougatsuResource.packer_parta_1.A3_6D_4_IPHONE_KOMA_ID, Vol3OsyougatsuResource.packer_parta_1.A3_6D_5_IPHONE_KOMA_ID,
				Vol3OsyougatsuResource.packer_parta_1.A3_6D_6_IPHONE_KOMA_ID, Vol3OsyougatsuResource.packer_parta_1.A3_6D_7_IPHONE_KOMA_ID, Vol3OsyougatsuResource.packer_parta_1.A3_6D_8_IPHONE_KOMA_ID,
				Vol3OsyougatsuResource.packer_parta_1.A3_6D_9_IPHONE_KOMA_ID);

		mCubicStopTiledTexture[CUBIC_ORANGE] = getTiledTextureFromPacker(tpBackGround, Vol3OsyougatsuResource.packer_parta_4.A3_6A_10_IPHONE_KOMA_ID, Vol3OsyougatsuResource.packer_parta_4.A3_6A_11_IPHONE_KOMA_ID);
		mCubicStopTiledTexture[CUBIC_BLUE] = getTiledTextureFromPacker(tpBackGround, Vol3OsyougatsuResource.packer_parta_4.A3_6B_10_IPHONE_KOMA_ID, Vol3OsyougatsuResource.packer_parta_4.A3_6B_11_IPHONE_KOMA_ID);
		mCubicStopTiledTexture[CUBIC_GREEN] = getTiledTextureFromPacker(tpBackGround, Vol3OsyougatsuResource.packer_parta_4.A3_6C_10_IPHONE_KOMA_ID, Vol3OsyougatsuResource.packer_parta_4.A3_6C_11_IPHONE_KOMA_ID);
		mCubicStopTiledTexture[CUBIC_YELLOW] = getTiledTextureFromPacker(tpBackGround, Vol3OsyougatsuResource.packer_parta_4.A3_6D_10_IPHONE_KOMA_ID, Vol3OsyougatsuResource.packer_parta_4.A3_6D_11_IPHONE_KOMA_ID);

		mCubicTurnOptionTiledTexture[0] = getTiledTextureFromPacker(tpThree, Vol3OsyougatsuResource.packer_parta_3.A3_6E_1_1_IPHONE_PRESENT_ID, Vol3OsyougatsuResource.packer_parta_3.A3_6E_1_2_IPHONE_PRESENT_ID);
		mCubicTurnOptionTiledTexture[1] = getTiledTextureFromPacker(tpTwo, Vol3OsyougatsuResource.packer_parta_2.A3_6E_2_1_IPHONE_PRESENT_ID, Vol3OsyougatsuResource.packer_parta_2.A3_6E_2_2_IPHONE_PRESENT_ID);
		mCubicTurnOptionTiledTexture[2] = getTiledTextureFromPacker(tpBackGround, Vol3OsyougatsuResource.packer_parta_4.A3_6E_3_1_IPHONE_PRESENT_ID, Vol3OsyougatsuResource.packer_parta_4.A3_6E_3_2_IPHONE_PRESENT_ID);
	...
	protected void drawScene() {
		...
		final Sprite spriteBackGround = new Sprite(960 / 2 - mBackGroundTextureRegion.getWidth() / 2, 0, mBackGroundTextureRegion, mVertexBufferObjectManager);
		this.attachChild(spriteBackGround);

		for (int i = 0; i < mTabSprite.length; i++) {
			mTabSprite[i] = new Sprite(960 / 2 - 1150 / 2, 89.5f, tpTab[i].getTexturePackTextureRegionLibrary().get(0), mVertexBufferObjectManager);
		...
		// Cubic Choose
		mCubicChooseSpite[CUBIC_YELLOW] = new Sprite(279, 70, tpOne.getTexturePackTextureRegionLibrary().get(Vol3OsyougatsuResource.packer_parta_1.A3_6_4_IPHONE_KOMA_ID), mVertexBufferObjectManager);
		this.attachChild(mCubicChooseSpite[CUBIC_YELLOW]);

		mCubicChooseSpite[CUBIC_GREEN] = new Sprite(200, 90f, tpOne.getTexturePackTextureRegionLibrary().get(Vol3OsyougatsuResource.packer_parta_1.A3_6_3_IPHONE_KOMA_ID), mVertexBufferObjectManager);
		this.attachChild(mCubicChooseSpite[CUBIC_GREEN]);

		mCubicChooseSpite[CUBIC_BLUE] = new Sprite(110, 107, tpOne.getTexturePackTextureRegionLibrary().get(Vol3OsyougatsuResource.packer_parta_1.A3_6_2_IPHONE_KOMA_ID), mVertexBufferObjectManager);
		this.attachChild(mCubicChooseSpite[CUBIC_BLUE]);

		mCubicChooseSpite[CUBIC_ORANGE] = new Sprite(22f, 135, tpOne.getTexturePackTextureRegionLibrary().get(Vol3OsyougatsuResource.packer_parta_1.A3_6_1_IPHONE_KOMA_ID), mVertexBufferObjectManager);
		...
		for (int i = CUBIC_ORANGE; i <= CUBIC_YELLOW; i++) {
			final TextureRegion iOTextureRegion = new TextureRegion(bitmapTexture[i % 2], 2, 2, mCubicStartTiledTexture[i].getWidth(), mCubicStartTiledTexture[i].getHeight());
			mCubicEntity[i] = new CubicEntity(0, 100, i, mCubicStartTiledTexture[i], mCubicTurnTiledTexture[i], mCubicStopTiledTexture[i], mCubicTurnOptionTiledTexture, iOTextureRegion);
		...
		mArrowSprite = new Sprite(120, 133, tpThree.getTexturePackTextureRegionLibrary().get(Vol3OsyougatsuResource.packer_parta_3.A3_8_1_IPHONE_YAJIRUSHI_ID), mVertexBufferObjectManager);
	...
	private void actionFace() {
		...
		this.registerEntityModifier(faceSequenceEntityModifier = new SequenceEntityModifier(new IEntityModifierListener() {
			...
			public void onLoopStarted(LoopModifier<IEntity> arg0, int pLoop, int pLoopCount) {
				// Log.i(TAG, "onLoopStarted pLoop " + pLoop + " pLoopCount " +
				// pLoopCount);
		...
		/*
		 * this.registerEntityModifier(faceSequenceEntityModifier = new
		 * LoopEntityModifier(new DelayModifier(0.4f), 5, new
		 * ILoopEntityModifierListener() {
		 * 
		 * @Override public void onLoopStarted(LoopModifier<IEntity> arg0, int
		 * pLoop, int pLoopCount) { //Log.i(TAG, "onLoopStarted pLoop " + pLoop
		 * + " pLoopCount " + pLoopCount); int index = ran * 5 + pLoop + 1; if
		 * (pLoop > 0) { mTabSprite[index - 1].setVisible(false); }
		 * mTabSprite[index].setVisible(true); }
		 * 
		 * @Override public void onLoopFinished(LoopModifier<IEntity> arg0, int
		 * pLoop, int pLoopCount) { int index = ran * 5 + pLoop + 1;
	...
	private class CubicEntity extends Sprite {
		...
		public CubicEntity(float pX, float pY, int pCubic, final ITiledTextureRegion pCubicStart, final ITiledTextureRegion pCubicTurn, final ITiledTextureRegion pCubicStop, final ITiledTextureRegion pCubicTurnOption[], ITextureRegion pTextureRegion) {
			...
			mScrollLeftSprite.registerEntityModifier(new LoopEntityModifier(new SequenceEntityModifier(new AlphaModifier(0.5f, 0.2f, 1.0f), new AlphaModifier(0.5f, 1.0f, 0.2f))));
		}
		...
		public int actionDown() {
			if (ACTION == ACTION_DEFAULT || ACTION == ACTION_TURN_START) {
				return -1;
			} else if (ACTION >= ACTION_TURN_LEVEL_1 && ACTION <= ACTION_TURN_LEVEL_3) {
				touchToTurn(ACTION);
			}
			return 1;
		}
	...
	public void onResumeGame() {
		...
		this.registerUpdateHandler(updateHandler = new IUpdateHandler() {
			...
			public void onUpdate(float f) {
				for (int i = 0; i < mCubicEntity.length; i++) {
					if (mCubicEntity[i].isVisible() && mCubicEntity[i].getCubicAction() >= CubicEntity.ACTION_TURN_LEVEL_1 && mCubicEntity[i].getCubicAction() <= CubicEntity.ACTION_TURN_FUNGI && mShishiAniSprite.isVisible() == true
