...
public class Vol3OsyougatsuBScene extends Vol3OsyougatsuScene {
	...
	public Vol3OsyougatsuBScene(final TexturePackLoaderFromSource pTexturePackLoaderFromSource, VertexBufferObjectManager pVertexBufferObjectManager, final TextureManager pTextureManager) {
	...
	private void loadTexture() {
		...
		mBackGroundTextureRegion = mTexturePack[0].getTexturePackTextureRegionLibrary().get(Vol3OsyougatsuResource.packer_partb_1.A3_12_IPHONE_HAIKEI_ID);

		mKakejikuTiledTexture = getTiledTextureFromPacker(mTexturePack[0], Vol3OsyougatsuResource.packer_partb_1.A3_7_1_IPHONE_KAKEJIKU_ID, Vol3OsyougatsuResource.packer_partb_1.A3_7_2_IPHONE_KAKEJIKU_ID,
				Vol3OsyougatsuResource.packer_partb_1.A3_7_3_IPHONE_KAKEJIKU_ID, Vol3OsyougatsuResource.packer_partb_1.A3_7_4_IPHONE_KAKEJIKU_ID, Vol3OsyougatsuResource.packer_partb_1.A3_7_5_IPHONE_KAKEJIKU_ID,
				Vol3OsyougatsuResource.packer_partb_1.A3_7_6_IPHONE_KAKEJIKU_ID);

		mDoorTiledTexture = getTiledTextureFromPacker(mTexturePack[0], Vol3OsyougatsuResource.packer_partb_1.A3_8_IPHONE_FUSUMA_ID, Vol3OsyougatsuResource.packer_partb_1.A3_8A_9_IPHONE_FUSUMA_ID,
				Vol3OsyougatsuResource.packer_partb_1.A3_8B_7_IPHONE_FUSUMA_ID, Vol3OsyougatsuResource.packer_partb_1.A3_8C_IPHONE_FUSUMA_ID);

		mDoorATiledTexture = getTiledTextureFromPacker(mTexturePack[1], Vol3OsyougatsuResource.packer_partb_2.A3_8A_1_IPHONE_FUSUMA_ID, Vol3OsyougatsuResource.packer_partb_2.A3_8A_2_IPHONE_FUSUMA_ID,
				Vol3OsyougatsuResource.packer_partb_2.A3_8A_3_IPHONE_FUSUMA_ID, Vol3OsyougatsuResource.packer_partb_2.A3_8A_4_IPHONE_FUSUMA_ID, Vol3OsyougatsuResource.packer_partb_2.A3_8A_5_IPHONE_FUSUMA_ID,
				Vol3OsyougatsuResource.packer_partb_2.A3_8A_6_IPHONE_FUSUMA_ID, Vol3OsyougatsuResource.packer_partb_2.A3_8A_7_IPHONE_FUSUMA_ID, Vol3OsyougatsuResource.packer_partb_2.A3_8A_8_IPHONE_FUSUMA_ID);
		mDoorBTiledTexture = getTiledTextureFromPacker(mTexturePack[2], Vol3OsyougatsuResource.packer_partb_3.A3_8B_1_IPHONE_FUSUMA_ID, Vol3OsyougatsuResource.packer_partb_3.A3_8B_2_IPHONE_FUSUMA_ID,
				Vol3OsyougatsuResource.packer_partb_3.A3_8B_3_IPHONE_FUSUMA_ID, Vol3OsyougatsuResource.packer_partb_3.A3_8B_4_IPHONE_FUSUMA_ID, Vol3OsyougatsuResource.packer_partb_3.A3_8B_5_IPHONE_FUSUMA_ID,
				Vol3OsyougatsuResource.packer_partb_3.A3_8B_6_IPHONE_FUSUMA_ID);

		mDoorCTiledTexture = getTiledTextureFromPacker(mTexturePack[3], Vol3OsyougatsuResource.packer_partb_4.A3_8C_1_1_IPHONE_FUSUMA_ID, Vol3OsyougatsuResource.packer_partb_4.A3_8C_1_2_IPHONE_FUSUMA_ID,
				Vol3OsyougatsuResource.packer_partb_4.A3_8C_1_3_IPHONE_FUSUMA_ID, Vol3OsyougatsuResource.packer_partb_4.A3_8C_1_4_IPHONE_FUSUMA_ID, Vol3OsyougatsuResource.packer_partb_4.A3_8C_1_5_IPHONE_FUSUMA_ID,
				Vol3OsyougatsuResource.packer_partb_4.A3_8C_1_6_IPHONE_FUSUMA_ID, Vol3OsyougatsuResource.packer_partb_4.A3_8C_2_1_IPHONE_FUSUMA_ID, Vol3OsyougatsuResource.packer_partb_4.A3_8C_2_2_IPHONE_FUSUMA_ID);
		mNusuTiledTexture = getTiledTextureFromPacker(mTexturePack[4], Vol3OsyougatsuResource.packer_partb_5.A3_9A_1_IPHONE_NASU_ID, Vol3OsyougatsuResource.packer_partb_5.A3_9A_2_IPHONE_NASU_ID,
				Vol3OsyougatsuResource.packer_partb_5.A3_9A_3_IPHONE_NASU_ID, Vol3OsyougatsuResource.packer_partb_5.A3_9A_4_IPHONE_NASU_ID, Vol3OsyougatsuResource.packer_partb_5.A3_9A_5_IPHONE_NASU_ID);
		mToriTiledTexture = getTiledTextureFromPacker(mTexturePack[4], Vol3OsyougatsuResource.packer_partb_5.A3_9B_1_IPHONE_TORI_ID, Vol3OsyougatsuResource.packer_partb_5.A3_9B_2_IPHONE_TORI_ID,
				Vol3OsyougatsuResource.packer_partb_5.A3_9B_3_IPHONE_TORI_ID, Vol3OsyougatsuResource.packer_partb_5.A3_9B_4_IPHONE_TORI_ID, Vol3OsyougatsuResource.packer_partb_5.A3_9B_5_IPHONE_TORI_ID);
		mFujisanTiledTexture = getTiledTextureFromPacker(mTexturePack[6], Vol3OsyougatsuResource.packer_partb_7.A3_9C_1_IPHONE_FUJISAN_ID, Vol3OsyougatsuResource.packer_partb_7.A3_9C_2_IPHONE_FUJISAN_ID,
				Vol3OsyougatsuResource.packer_partb_7.A3_9C_3_IPHONE_FUJISAN_ID, Vol3OsyougatsuResource.packer_partb_7.A3_9C_4_IPHONE_FUJISAN_ID, Vol3OsyougatsuResource.packer_partb_7.A3_9C_5_IPHONE_FUJISAN_ID,
				Vol3OsyougatsuResource.packer_partb_7.A3_9C_6_IPHONE_FUJISAN_ID, Vol3OsyougatsuResource.packer_partb_7.A3_9C_7_IPHONE_FUJISAN_ID, Vol3OsyougatsuResource.packer_partb_7.A3_9C_8_IPHONE_FUJISAN_ID,
				Vol3OsyougatsuResource.packer_partb_7.A3_9C_9_IPHONE_FUJISAN_ID);
		mMochiTiledTexture = new ITiledTextureRegion[] { getTiledTextureFromPacker(mTexturePack[0], Vol3OsyougatsuResource.packer_partb_1.A3_10A_1_IPHONE_MOCHI_ID, Vol3OsyougatsuResource.packer_partb_1.A3_10B_1_IPHONE_MOCHI_ID),
				getTiledTextureFromPacker(mTexturePack[0], Vol3OsyougatsuResource.packer_partb_1.A3_10A_2_IPHONE_MOCHI_ID, Vol3OsyougatsuResource.packer_partb_1.A3_10B_2_IPHONE_MOCHI_ID),
				getTiledTextureFromPacker(mTexturePack[0], Vol3OsyougatsuResource.packer_partb_1.A3_10A_3_IPHONE_MOCHI_ID, Vol3OsyougatsuResource.packer_partb_1.A3_10B_3_IPHONE_MOCHI_ID),
				getTiledTextureFromPacker(mTexturePack[0], Vol3OsyougatsuResource.packer_partb_1.A3_10A_4_IPHONE_MOCHI_ID, Vol3OsyougatsuResource.packer_partb_1.A3_10B_4_IPHONE_MOCHI_ID),
				getTiledTextureFromPacker(mTexturePack[0], Vol3OsyougatsuResource.packer_partb_1.A3_10A_5_IPHONE_MOCHI_ID, Vol3OsyougatsuResource.packer_partb_1.A3_10B_5_IPHONE_MOCHI_ID),
				getTiledTextureFromPacker(mTexturePack[0], Vol3OsyougatsuResource.packer_partb_1.A3_10A_6_IPHONE_MOCHI_ID, Vol3OsyougatsuResource.packer_partb_1.A3_10B_6_IPHONE_MOCHI_ID),
				getTiledTextureFromPacker(mTexturePack[0], Vol3OsyougatsuResource.packer_partb_1.A3_10A_7_IPHONE_MOCHI_ID, Vol3OsyougatsuResource.packer_partb_1.A3_10B_7_IPHONE_MOCHI_ID),
				getTiledTextureFromPacker(mTexturePack[0], Vol3OsyougatsuResource.packer_partb_1.A3_10A_8_IPHONE_MOCHI_ID, Vol3OsyougatsuResource.packer_partb_1.A3_10B_8_IPHONE_MOCHI_ID),
				getTiledTextureFromPacker(mTexturePack[0], Vol3OsyougatsuResource.packer_partb_1.A3_10A_9_IPHONE_MOCHI_ID, Vol3OsyougatsuResource.packer_partb_1.A3_10B_9_IPHONE_MOCHI_ID),
				getTiledTextureFromPacker(mTexturePack[0], Vol3OsyougatsuResource.packer_partb_1.A3_10A_10_IPHONE_MOCHI_ID, Vol3OsyougatsuResource.packer_partb_1.A3_10B_10_IPHONE_MOCHI_ID) };

		mFlashEndTiledTexture = getTiledTextureFromPacker(mTexturePack[5], Vol3OsyougatsuResource.packer_partb_6.A3_11_1_IPHONE_KAKEJIKU_ID, Vol3OsyougatsuResource.packer_partb_6.A3_11_2_IPHONE_KAKEJIKU_ID,
				Vol3OsyougatsuResource.packer_partb_6.A3_11_3_IPHONE_KAKEJIKU_ID, Vol3OsyougatsuResource.packer_partb_6.A3_11_4_IPHONE_KAKEJIKU_ID, Vol3OsyougatsuResource.packer_partb_6.A3_11_5_IPHONE_KAKEJIKU_ID,
				Vol3OsyougatsuResource.packer_partb_6.A3_11_6_IPHONE_KAKEJIKU_ID, Vol3OsyougatsuResource.packer_partb_6.A3_11_7_IPHONE_KAKEJIKU_ID, Vol3OsyougatsuResource.packer_partb_6.A3_11_8_IPHONE_KAKEJIKU_ID);
	...
	protected void drawScene() {
		...
		spriteBackGround = new Sprite(960 / 2 - mBackGroundTextureRegion.getWidth() / 2, 0, mBackGroundTextureRegion, mVertexBufferObjectManager);
		...
		mBoxSprite = new Sprite(364, 442, mTexturePack[0].getTexturePackTextureRegionLibrary().get(Vol3OsyougatsuResource.packer_partb_1.A3_10_1_IPHONE_SANPOW_ID), mVertexBufferObjectManager);
		this.attachChild(mBoxSprite);
		mSanpowSprite = new Sprite(662, 408, mTexturePack[0].getTexturePackTextureRegionLibrary().get(Vol3OsyougatsuResource.packer_partb_1.A3_10_2_IPHONE_SANPOW_ID), mVertexBufferObjectManager);
		...
		mArrowSprite = new Sprite(498, 326, mTexturePack[4].getTexturePackTextureRegionLibrary().get(Vol3OsyougatsuResource.packer_partb_5.A3_13_IPHONE_YAJIRUSHI_ID), mVertexBufferObjectManager);
		...
		public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY) {
			...
			if (pSceneTouchEvent.isActionDown()) {
				...
				if (mSanpowSprite.contains(pX, pY)) {
					// todo nothing
				} else if (checkContains(mKakejikuAniSprite, 0, 0, 72, 63, (int) pX, (int) pY) && !mKakejikuAniSprite.isAnimationRunning()) {
					actionKakejiku();
				} else if (checkContains(mDoorAniSprite, 126, 60, 446, 352, (int) pX, (int) pY) && !isActionDoor) {
					actionDoor();
				} else if (checkContains(spriteBackGround, 15, 295, 955, 638, (int) pX, (int) pY)) {
					actionTabToFront();
				}
			}
	...
	private static final int POINT_NUSU[][] = new int[][] { { 120, 400 }, { 130, 600 }, { 500, 400 } };
		...
		if (ran == 0 && !mNusuAniSprite[1].isVisible()) { // Nusu
			...
			mNusuAniSprite[1].registerEntityModifier(new MoveYModifier(1.0f, mNusuAniSprite[1].getY(), mNusuAniSprite[1].getY() + POINT_NUSU[ranPoint][1], new IEntityModifierListener() {
				...
				public void onModifierFinished(IModifier<IEntity> arg0, IEntity arg1) {
					...
					mNusuAniSprite[1].registerEntityModifier(new SequenceEntityModifier(new DelayModifier(0.4f), new MoveXModifier((offsetDuration * pY) / 1000, mNusuAniSprite[1].getX(), -mNusuAniSprite[1].getWidth(), new IEntityModifierListener() {
			...
			mNusuAniSprite[0].registerEntityModifier(new MoveYModifier(1.0f, mNusuAniSprite[0].getY(), mNusuAniSprite[0].getY() + POINT_NUSU[ranPoint][1], new IEntityModifierListener() {
				...
				public void onModifierFinished(IModifier<IEntity> arg0, IEntity arg1) {
					...
					mNusuAniSprite[0].registerEntityModifier(new SequenceEntityModifier(new DelayModifier(0.4f), new MoveXModifier((offsetDuration * pY) / 1000, mNusuAniSprite[0].getX(), -mNusuAniSprite[0].getWidth(), new IEntityModifierListener() {
			...
			mToriAniSprite[0].registerEntityModifier(new MoveYModifier(1.0f, mToriAniSprite[0].getY(), mToriAniSprite[0].getY() + POINT_NUSU[ranPoint][1], new IEntityModifierListener() {
				...
				public void onModifierFinished(IModifier<IEntity> arg0, IEntity arg1) {
					...
					mToriAniSprite[0].registerEntityModifier(new SequenceEntityModifier(new DelayModifier(0.4f), new MoveXModifier((offsetDuration * pY) / 1000, mToriAniSprite[0].getX(), -mToriAniSprite[0].getWidth(), new IEntityModifierListener() {
			...
			mToriAniSprite[1].registerEntityModifier(new MoveYModifier(1.0f, mToriAniSprite[1].getY(), mToriAniSprite[1].getY() + POINT_NUSU[ranPoint][1], new IEntityModifierListener() {
				...
				public void onModifierFinished(IModifier<IEntity> arg0, IEntity arg1) {
					...
					mToriAniSprite[1].registerEntityModifier(new SequenceEntityModifier(new DelayModifier(0.4f), new MoveXModifier((offsetDuration * pY) / 1000, mToriAniSprite[1].getX(), -mToriAniSprite[1].getWidth(), new IEntityModifierListener() {
			...
			mFujisanAniSprite.animate(new long[] { 250, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250 }, new int[] { 0, 1, 2, 3, 4, 5, 6, 7, 8, 8, 8 }, 0, new IAnimationListener() {
				int countFrame = 0;

				@Override
				public void onAnimationStarted(AnimatedSprite animatedSprite, int arg1) {
					animatedSprite.setPosition(960 / 2 - mFujisanTiledTexture.getWidth(0) / 2, 640 / 2 - mFujisanTiledTexture.getHeight(0) / 2);
				...
				public void onAnimationFrameChanged(AnimatedSprite animatedSprite, int arg1, int arg2) {
					...
					animatedSprite.setPosition(960 / 2 - mFujisanTiledTexture.getWidth(frame) / 2, 640 / 2 - mFujisanTiledTexture.getHeight(frame) / 2);
	...
	private void actionDoor() {
		...
		if (ran == 0) { // Action A
			mDoorAAniSprite.animate(new long[] { 250, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250 }, new int[] { 0, 1, 2, 3, 4, 5, 6, 7, 6, 7, 6, 7, 6, 7 }, 0, new IAnimationListener() {
				int count = 0;
	...
	private void showArrow() {
		if (listMochiUsed.size() == 0) {
			...
			mArrowSprite.clearEntityModifiers();
			mArrowSprite.registerEntityModifier(new LoopEntityModifier(new SequenceEntityModifier(new AlphaModifier(0.5f, 0.2f, 1.0f), new AlphaModifier(0.5f, 1.0f, 0.2f))));
		}
	}
	...
	class MochiAniSprite extends AnimatedSprite {
		...
		public MochiAniSprite(int pIndex, float pX, float pY, ITiledTextureRegion pTiledTextureRegion, VertexBufferObjectManager pVertexBufferObjectManager) {
		...
		public void actionMoveUp() {
			...
			} else if (mColLeft.contains(pX, pY) || mColRight.contains(pX, pY)) {
				/*
				 * MochiAniSprite.this.resetAll(); newActionMochi(index);
				 */
					...
					this.registerEntityModifier(new MoveYModifier(duration, this.getY(), pointer_mochi, new IEntityModifierListener() {
						...
						public void onModifierFinished(IModifier<IEntity> arg0, IEntity arg1) {
							...
							MochiAniSprite.this.registerEntityModifier(new ParallelEntityModifier(
									new MoveModifier(1.0f, MochiAniSprite.this.getX(), MochiAniSprite.this.getX() + toX, MochiAniSprite.this.getY(), MochiAniSprite.this.getHeight() + 640), new RotationModifier(1.0f, 0, roate)));
							for (int i = 0; i < listMochiUsed.size(); i++) {
								...
								aniSprite.registerEntityModifier(new ParallelEntityModifier(new MoveModifier(1.0f, aniSprite.getX(), aniSprite.getX() + toX, aniSprite.getY(), aniSprite.getHeight() + 640), new RotationModifier(1.0f, 0, roate)));
							}
