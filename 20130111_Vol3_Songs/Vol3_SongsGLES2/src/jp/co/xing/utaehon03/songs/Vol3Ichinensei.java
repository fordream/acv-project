...
//	private Sprite mSpriteAttach;
	...
	private TextureRegion ttrBackground1, ttrBackground2, ttrBackground3, ttrSita, ttrSeeSaw61, ttrSeeSaw62, ttrSeeSaw63, ttrSeeSaw64, ttrSeeSaw65,
						  ttrSakuraLeft, ttrSakuraRight, ttrChildrenBefore, ttrChildRun1, ttrChildRun2, ttrChildRun3, ttrChildAfter11, ttrChildAfter12,
						  ttrChildAfter21, ttrChildAfter22, ttrChildAfter31;
	...
	private Sprite sBackground1, sBackground2, sBackground3, sSita, sSeeSaw61, sSeeSaw62, sSeeSaw63Left, sSeeSaw63Right, sSeeSaw64, sSeeSaw65,
				   sSakuraLeft, sSakuraRight, sChildrenBefore, sChildRun1, sChildRun2, sChildRun3, sChildAfter11, sChildAfter12, sChildAfter21, sChildAfter22,
				   sChildAfter31;
	...
	private TiledTextureRegion tttrChildren1, tttrChildren2, tttrChildren3, tttrChildren4, tttrPengin, tttrAkashia, tttrArikui, tttrMandoriru,
							   tttrKapibara, tttrAmuruhyou, tttrOtosay, tttrIruka, tttrKuma;
	private AnimatedSprite asChildren1, asChildren2, asChildren3, asChildren4, asPengin, asAkashia, asArikui, asMandoriru, asKapibara,
						   asAmuruhyou, asOtosay, asIruka, asKuma;
	...
	private boolean	isTouchPengin, isTouchAkashia, isTouchArikui, isTouchMandoriru, isTouchKapibara, isTouchAmuruhyou, isTouchOtosay,
					isTouchIkura, isTouchKuma, isTouchHaikei, isTouchChilds, isTouchSakura, isTouch;
	...
	private Sound mp3Sisonosetene, mp3Pengin, mp3Pengin_vo, mp3Akashia, mp3Akashia_vo, mp3Arikui, mp3Arikui_vo, mp3Mandoriru, mp3Mandoriru_vo, 
				  mp3Kapibara, mp3Kapibara_vo, mp3Amuruhyou, mp3Amuruhyou_vo, mp3Otosay, mp3Otosay_vo, mp3Iruka, mp3Iruka_vo, mp3Kuma, mp3Kuma_vo,
				  mp3Kodomo, mp3Onigirikorogaru, mp3Sakura, mp3Wai, mp3Siso, mp3Pakun, mp3Musya,
				  mp3Yoisyo1, mp3Yoisyo2, mp3Hakusyu, mp3Onajiomosa, mp3Yata, mp3Gogogo, mp3Siso_noseru;
	
	private int lastX = 0;
	private int lastY = 0;
	final Sprite pFlower[] = new Sprite[9];
	private boolean isTouchAni[] = new boolean[]{
	...
	protected void loadKaraokeResources() {
		...
		this.tttrChildren1 = getTiledTextureFromPacker(ttpIchinensei1, 
				Vol3IchinenseiResource.A2_7_2_IPHONE_KODOMO_ID,
				Vol3IchinenseiResource.A2_7_3_IPHONE_KODOMO_ID);
		this.tttrChildLast1 = getTiledTextureFromPacker(ttpIchinensei1, 
				Vol3IchinenseiResource.A2_7_4_IPHONE_KODOMO_ID,
				Vol3IchinenseiResource.A2_7_5_IPHONE_KODOMO_ID,
				Vol3IchinenseiResource.A2_7_6_IPHONE_KODOMO_ID);
		
		this.ttrChildren2 = ttpLibIchinensei1.get(Vol3IchinenseiResource.A2_8_1_IPHONE_KODOMO_ID);
		this.tttrChildren2 = getTiledTextureFromPacker(ttpIchinensei1,				
				Vol3IchinenseiResource.A2_8_2_IPHONE_KODOMO_ID,
				Vol3IchinenseiResource.A2_8_3_IPHONE_KODOMO_ID);
		this.tttrChildLast2 = getTiledTextureFromPacker(ttpIchinensei1, 
				Vol3IchinenseiResource.A2_8_4_IPHONE_KODOMO_ID,
				Vol3IchinenseiResource.A2_8_5_IPHONE_KODOMO_ID,
				Vol3IchinenseiResource.A2_8_6_IPHONE_KODOMO_ID);
		
		this.ttrChildren3 = ttpLibIchinensei1.get(Vol3IchinenseiResource.A2_9_1_IPHONE_KODOMO_ID);
		this.tttrChildren3 = getTiledTextureFromPacker(ttpIchinensei1, 
				Vol3IchinenseiResource.A2_9_2_IPHONE_KODOMO_ID,
				Vol3IchinenseiResource.A2_9_3_IPHONE_KODOMO_ID);
		this.tttrChildLast3 = getTiledTextureFromPacker(ttpIchinensei1, 
				Vol3IchinenseiResource.A2_9_4_IPHONE_KODOMO_ID,
				Vol3IchinenseiResource.A2_9_5_IPHONE_KODOMO_ID,
				Vol3IchinenseiResource.A2_9_6_IPHONE_KODOMO_ID);
		
		this.ttrChildren4 = ttpLibIchinensei1.get(Vol3IchinenseiResource.A2_10_1_IPHONE_KODOMO_ID);
		this.tttrChildren4 = getTiledTextureFromPacker(ttpIchinensei1,
				Vol3IchinenseiResource.A2_10_2_IPHONE_KODOMO_ID,
				Vol3IchinenseiResource.A2_10_3_IPHONE_KODOMO_ID);
		this.tttrChildLast4 = getTiledTextureFromPacker(ttpIchinensei1,
				Vol3IchinenseiResource.A2_10_4_IPHONE_KODOMO_ID,
				Vol3IchinenseiResource.A2_10_5_IPHONE_KODOMO_ID,
				Vol3IchinenseiResource.A2_10_6_IPHONE_KODOMO_ID);
		...
		this.tttrPengin = getTiledTextureFromPacker(ttpIchinensei1,
				Vol3IchinenseiResource.A2_11_2_IPHONE_PENGIN_ID,
				Vol3IchinenseiResource.A2_11_3_IPHONE_PENGIN_ID);
		
		this.ttrAkashia = ttpLibIchinensei1.get(Vol3IchinenseiResource.A2_12_1_IPHONE_AKASHIA_ID);
		this.tttrAkashia = getTiledTextureFromPacker(ttpIchinensei1,
				Vol3IchinenseiResource.A2_12_2_IPHONE_AKASHIA_ID,
				Vol3IchinenseiResource.A2_12_3_IPHONE_AKASHIA_ID);
		
		this.ttrArikui = ttpLibIchinensei1.get(Vol3IchinenseiResource.A2_13_1_IPHONE_ARIKUI_ID);
		this.tttrArikui = getTiledTextureFromPacker(ttpIchinensei1,
				Vol3IchinenseiResource.A2_13_2_IPHONE_ARIKUI_ID,
				Vol3IchinenseiResource.A2_13_3_IPHONE_ARIKUI_ID);
		
		this.ttrMandoriru = ttpLibIchinensei1.get(Vol3IchinenseiResource.A2_14_1_IPHONE_MANDORIRU_ID);
		this.tttrMandoriru = getTiledTextureFromPacker(ttpIchinensei1, 
				Vol3IchinenseiResource.A2_14_2_IPHONE_MANDORIRU_ID,
				Vol3IchinenseiResource.A2_14_3_IPHONE_MANDORIRU_ID);
		
		this.ttrKapibara = ttpLibIchinensei1.get(Vol3IchinenseiResource.A2_15_1_IPHONE_KAPIBARA_ID);
		this.tttrKapibara = getTiledTextureFromPacker(ttpIchinensei1,
				Vol3IchinenseiResource.A2_15_2_IPHONE_KAPIBARA_ID,
				Vol3IchinenseiResource.A2_15_3_IPHONE_KAPIBARA_ID);
		
		this.ttrAmuruhyou = ttpLibIchinensei2.get(Vol3IchinenseiResource.A2_16_1_IPHONE_AMURUHYOU_ID);
		this.tttrAmuruhyou = getTiledTextureFromPacker(ttpIchinensei2,
				Vol3IchinenseiResource.A2_16_2_IPHONE_AMURUHYOU_ID,
				Vol3IchinenseiResource.A2_16_3_IPHONE_AMURUHYOU_ID);
		
		this.ttrOtosay = ttpLibIchinensei2.get(Vol3IchinenseiResource.A2_17_1_IPHONE_OTOSAY_ID);
		this.tttrOtosay = getTiledTextureFromPacker(ttpIchinensei2, 
				Vol3IchinenseiResource.A2_17_2_IPHONE_OTOSAY_ID,
				Vol3IchinenseiResource.A2_17_3_IPHONE_OTOSAY_ID);
		
		this.ttrIruka = ttpLibIchinensei2.get(Vol3IchinenseiResource.A2_18_1_IPHONE_IRUKA_ID);
		this.tttrIruka = getTiledTextureFromPacker(ttpIchinensei2,
				Vol3IchinenseiResource.A2_18_2_IPHONE_IRUKA_ID,
				Vol3IchinenseiResource.A2_18_3_IPHONE_IRUKA_ID);
		
		this.ttrKuma = ttpLibIchinensei2.get(Vol3IchinenseiResource.A2_19_1_IPHONE_KUMA_ID);
		this.tttrKuma = getTiledTextureFromPacker(ttpIchinensei2,
				Vol3IchinenseiResource.A2_19_2_IPHONE_KUMA_ID,
				Vol3IchinenseiResource.A2_19_3_IPHONE_KUMA_ID);
...
//		mSpriteAttach.setZIndex(999);
//		sprGimmic[0].setZIndex(1000);
//		sprGimmic[1].setZIndex(1001);
//		sprGimmic[2].setZIndex(1002);
//		this.mScene.sortChildren();
	...
	public boolean onSceneTouchEvent(Scene pScene, TouchEvent pSceneTouchEvent) {
		...
		if(pSceneTouchEvent.getAction() == TouchEvent.ACTION_DOWN) {
			...
			if(sChildren1.contains(pX, pY) &&  sChildren1.isVisible()) {
	...
	private void _touchChild(final Sprite sChildren) {
		if(isTouchAction) {
			isTouchAction = false;
			mp3Sisonosetene.stop();
			sChildren.registerEntityModifier(new SequenceEntityModifier(
					new MoveYModifier(0.1f, sChildren.getmYFirst(), sChildren.getmYFirst() - 15),
					new MoveYModifier(0.1f, sChildren.getmYFirst() - 15, sChildren.getmYFirst(), new IEntityModifierListener() {
						@Override
	...
	private void setZIndexs(final Sprite ...asChild){
		...
		//Vol3Ichinensei.this.mScene.sortChildren();
	...
	private void collidesAnimalWithRectangle(Sprite sAnimal, AnimatedSprite asAnimal, int pX, int pY) {
		...
		if(checkContains(sSeeSaw62, 324, -100, 537, 200, pX, pY)) {
			...
			if(sAnimal.equals(sPengin)) {
				sPenginLast.setVisible(true);
				sAnimals = sPengin;
				iAnimal = 1;
			} else if(sAnimal.equals(sAkashia)) {
				sAkashiaLast.setVisible(true);
				sAnimals = sAkashia;
				iAnimal = 1;
			} else if(sAnimal.equals(sArikui)) {
				sArikuiLast.setVisible(true);			
				sAnimals = sArikui;
				iAnimal = 2;
			} else if(sAnimal.equals(sMandoriru)) {
				sMandoriruLast.setVisible(true);
				sAnimals = sMandoriru;
				iAnimal = 2;
			} else if(sAnimal.equals(sKapibara)) {
				sKapibaraLast.setVisible(true);
				iAnimal = 3;
				sAnimals = sKapibara;
			} else if(sAnimal.equals(sAmuruhyou)) {
				sAmuruhyouLast.setVisible(true);
				sAnimals = sAmuruhyou;
				iAnimal = 3;
			} else if(sAnimal.equals(sOtosay)) {
				sOtosayLast.setVisible(true);
				sAnimals = sOtosay;
				iAnimal = 4;
			} else if(sAnimal.equals(sIruka)) {
				sIrukaLast.setVisible(true);
				sAnimals = sIruka;
				iAnimal = 4;
			} else if(sAnimal.equals(sKuma)) {
				sKumaLast.setVisible(true);
				sAnimals = sKuma;
				iAnimal = 4;
			}
			compareChildWithAnimal();
	...
	private void roateSeeSaw(final float pPoint[], float ptime[]){
		...
		new RotationModifier(ptime[0], isRotate,  pPoint[1]),
		new RotationModifier(ptime[1], pPoint[2],  pPoint[3]),
		new RotationModifier(ptime[2], pPoint[4],  pPoint[5]),
		new RotationModifier(ptime[3], pPoint[6],  pPoint[7])
		));
	}
	...
	private void touchHaikei() {
		if(isTouchHaikei) {
			isTouchHaikei = false;
			mp3Gogogo.play();
			sBackground3.registerEntityModifier(new SequenceEntityModifier(
					new MoveXModifier(0.2f, 45, 55),
					new MoveXModifier(0.2f, 55, 35),
					new MoveXModifier(0.2f, 35, 55, new IEntityModifierListener() {
						@Override
						public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
							mp3Gogogo.play();
						}
					...
					new MoveXModifier(0.2f, 55, 35),
					new MoveXModifier(0.2f, 35, 45, new IEntityModifierListener() {						
						@Override
						public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
						}						
						@Override
	...
	private void touchChilds() {
		if(isTouchChilds) {
			...
			sChildRun2.registerEntityModifier(new SequenceEntityModifier(
					new ParallelEntityModifier(
							new ScaleModifier(1.0f, 1.0f, 0.5f),
							new MoveXModifier(1.0f, 258, 200, new IEntityModifierListener() {								
								@Override
								public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
								}
								...
								public void onModifierFinished(IModifier<IEntity> arg0, IEntity arg1) {
									...
									sChildRun2.registerEntityModifier(new SequenceEntityModifier(
											new ParallelEntityModifier(
													new ScaleModifier(3.0f, 0.5f, 0.2f),
	...
	private void touchChildAfter() {
		if(isTouchChildAfter) {
			...
			sChildAfter31.registerEntityModifier(new SequenceEntityModifier(
					new ParallelEntityModifier(
							new RotationAtModifier(3.0f, 0, 720, sChildAfter31.getWidth() / 2, sChildAfter31.getHeight() / 2),
							new ScaleModifier(3.0f, 1.0f, 1.5f),
							new PathModifier(3.0f, pPath, new IPathModifierListener() {
	...
	public void actionChilds(Sprite sprite1, Sprite sprite2) {
		sprite1.registerEntityModifier(new LoopEntityModifier(
				new SequenceEntityModifier(
						new MoveXModifier(0.5f, sprite1.getmXFirst(), sprite1.getmXFirst() + 2),
						new MoveXModifier(0.5f, sprite1.getX() + 2, sprite1.getmXFirst() - 2),
						new MoveXModifier(0.5f, sprite1.getmXFirst() - 2, sprite1.getmXFirst()))));
		
		sprite2.registerEntityModifier(new LoopEntityModifier(
				new SequenceEntityModifier(
						new MoveXModifier(0.5f, sprite2.getmXFirst(), sprite2.getmXFirst() - 2),
						new MoveXModifier(0.5f, sprite2.getX() - 2, sprite2.getmXFirst() + 2),
						new MoveXModifier(0.5f, sprite2.getmXFirst() + 2, sprite2.getmXFirst()))));
	}
	
	private void childSleep() {
		mScene.unregisterUpdateHandler(timerChild);
		timerChild = new TimerHandler(10.0f, true, 
				new ITimerCallback() {					
					@Override
					public void onTimePassed(TimerHandler arg0) {						
