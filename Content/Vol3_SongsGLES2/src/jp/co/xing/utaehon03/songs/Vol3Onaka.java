...
public class Vol3Onaka extends BaseGameActivity implements
	...
	private void resetData() {
		...
		if(mp3OnakaBowan != null) {
			mp3OnakaBowan.pause();
		}
		
		if(mp3OnakaBoyon != null) {
			mp3OnakaBoyon.pause();
		}
		
		if(mp3OnakaDudu != null) {
			mp3OnakaDudu.pause();
		}
		...
		if(mp3OnakaItadakimasu != null) {
			mp3OnakaItadakimasu.pause();
		}
		
		if(mp3OnakaKonkon != null) {
			mp3OnakaKonkon.pause();
		}
		
		if(mp3OnakaMokin != null) {
			mp3OnakaMokin.pause();
		}
		
		if(mp3OnakaMoni != null) {
			mp3OnakaMoni.pause();
		}
		
		if(mp3OnakaNyun != null) {
			mp3OnakaNyun.pause();
		}
		
		if(mp3OnakaPaka != null) {
			mp3OnakaPaka.pause();
		}
		
		if(mp3OnakaPowa != null) {
			mp3OnakaPowa.pause();
		}
		
		if(mp3OnakaSakuton != null) {
			mp3OnakaSakuton.pause();
		}
		
		if(mp3Onakasuita != null) {
			mp3Onakasuita.pause();
		}
		
		if(mp3OnakaToire != null) {
			mp3OnakaToire.pause();
		}
		...
		if(mp3OnakaUnchi != null) {
			mp3OnakaUnchi.pause();
		}
		
		if(mp3Taberuoto != null) {
			mp3Taberuoto.pause();
		}
	}
