...
public class Vol3Aiai extends BaseGameActivity implements
	...
	private void loadAndroidFrame() {
		...
		// Create widget
		imgScrollViewHeader = new ImageView(this);
		...
		imgbackground = new ImageView(this);
		...
		for (int i = 0; i < ListIteam.length; i++) {
			imgIteam[i] = new ImageViewIteam(this, i, ListIteam[i][0]);
