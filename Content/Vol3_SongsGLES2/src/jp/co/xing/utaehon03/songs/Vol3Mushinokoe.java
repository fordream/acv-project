...
public class Vol3Mushinokoe extends BaseGameActivity implements IOnSceneTouchListener, 
	IAnimationListener{
	private static final String TAG = "LOG_MUSHINOKOE";
	RectangularShape shapeAmi , shapeKuwagata, shapeKabuto ,shapeKirigirisu, shapeTentoumushi,shapeKamakiri,
			shapeTonbo, shapeCyou1, shapeCyou2, shapeHachi1, shapeHachi2, shapeHachi3, shapeSemi1, shapeSemi2
			,shapeAri, shapeDango, shapeKamikiri, shapeKogane, shapeYoutyu,shapeHotaru, shapeMatsumushi, shapeSuzumushi;
	private TimerHandler tTimer;
	
	private TexturePackLoaderFromSource mTexturePackLoaderFromSource;
	private TexturePack ttpMushinokoe1,ttpMushinokoe2,ttpMushinokoe3,ttpMushinokoe4,
			ttpMushinokoe5;
	private TexturePackTextureRegionLibrary ttpLibMushinokoe1,ttpLibMushinokoe2,ttpLibMushinokoe3,
			ttpLibMushinokoe4,ttpLibMushinokoe5;
	
	private TextureRegion ttrBackGround1, ttrBackGround2, ttrBackGround3,ttrBackGround4 ,
			ttrAmi , ttrMushikago,
			ttrnameOneKuwagata, ttrOneKuwagata4, ttrOneKuwagata5, ttrnameOneKabuto, 
			ttrOneKabuto4, ttrOneKabuto5,
			
			ttrKirigirisu, ttrnameKirigirisu, ttrKirigirisu6, ttrnameTentoumushi, ttrTentoumushi4, ttrKamakiri1, 
			ttrKamakiri2, ttrKamakiri3, ttrnameKamakiri, ttrKamakiri5, ttrTonbo3, ttrnameTonbo, ttrTonbo5
			,ttrCyou1, ttrnameCyou, ttrCyou5, ttrCyou6, ttrHachi1, ttrHachi2, ttrHachi3, ttrHachi4, 
			ttrHachi5,ttrnameHachi, ttrHachi7, ttrSemi1, ttrSemi2, ttrSemi3,ttrnameSemi, ttrSemi5, ttrSemi6
			, ttrnameAri, ttrAri5, ttrnameDango, ttrDango5, ttrnameKamikiri, ttrKamikiri4, ttrnameKogane,
			ttrKogane5, ttrnameYoutyu, ttrYoutyu6,
	
			ttrHotaru1,ttrHotaru2,ttrHotaru3,ttrnameHotaru,ttrHotaru5, ttrMatsumushi1, ttrnameMatsumushi, ttrMatsumuchi5,
			ttrSuzumushi1, ttrnameSuzumushi, ttrSuzumushi5,ttrHake1,ttrHake2,ttrHake3;
	
	private Sprite sBackGround1, sBackGround2, sBackGround3, sBackGround4,sAmi, sMushikago , 
			snameOneKugawata, sOneKugawata4, sOneKugawata5, snameOneKabuto, sOneKabuto4, 
			sOneKabuto5,
			
			sKirigirisu, snameKirigirisu, sKirigirisu6, snameTentoumushi, sTentoumushi4, sKamakiri1, sKamakiri2, 
			sKamakiri3, snameKamakiri, sKamakiri5, sTonbo3, snameTonbo, sTonbo5, sCyou1, snameCyou, 
			sCyou5,sCyou6, sHachi1,sHachi2,sHachi3,sHachi4,sHachi5,snameHachi,sHachi7, sSemi1,
			sSemi2,sSemi3,snameSemi,sSemi5, sSemi6, snameAri, sAri5, snameDango, sDango5,snameKamikiri
			, sKamikiri4 ,snameKogane,sKogane5, snameYoutyu, sYoutyu6,
	
			sHotaru1,sHotaru2,sHotaru3,snameHotaru,sHotaru5 ,sMatsumushi1,snameMatsumushi ,sMatsumushi5
			, sSuzumushi1, snameSuzumushi, sSuzumushi5, sHake1,sHake2,sHake3;
	
	private TiledTextureRegion tttrKuwagata, tttrKabuto, tttrKirigirisu, tttrTentoumushi, tttrTonbo
			, tttrCyou, tttrAri, tttrDango, tttrKamikiri , tttrKogane , tttrYoutyu, tttrMatsumushi, tttrSuzumushi;
	
	private AnimatedSprite animKuwagata, animKabuto, animKirigirisu, animTentoumushi, animTonbo, animCyou
		, animAri, animDango, animKamikiri, animKogane, animYoutyu, animMatsumushi, animSuzumushi;
	
	private Calendar mCalendar;
	
	private int cases = 0 , current, pTentoumushi = 0 , checkCyouFly, checkKamakiri, checkSemi ,checkTentoumushi
			,checkAri ,checkDango ,checkKamikiri, checkKogane, checkYoutyu,
			pAri = 0, pDango = 0, pKamikiri = 0 ,pKogane , pYoutyu =0;
	
	private boolean isAmiMove,enableCatch, isCatch, isTouchKuwagata, isTouchKabuto, isTouchKirigirisu , isTouchKamakiri
		, isTouchTonbo, isTouchCyou, isTouchHachi , isTouchSemi, isTouchHotaru, isTouchMatsumushi, isTouchSuzumushi
		,isTouchHake,isFaceKabuto, isFaceKuwagata,isTouchKamikiri, checkNight;
	
	private boolean  notCatchKuwagata, notCatchKabuto, notCatchKirigirisu, notCatchTentoumushi
			, notCatchKamakiri, notCatchTonbo, notCatchCyou, notCatchHachi, notCatchSemi, notCatchAri
			, notCatchDango , notCatchKamikiri ,notCatchKogane , notCatchYoutyu, notCatchHotaru, 
			notCatchMatsumushi, notCatchSuzumushi;
	
	private boolean isKuwagataJump, isKabutoJump, isKirigirisuJump, isTentoumushiJump, isKamakiriJump, isTonboJump
		,isCyouJump, isHachiJump, isSemiJump, isAriJump, isDangoJump, isKamikiriJump , isKoganeJump , isYoutyuJump,
		isHotaruJump, isMatsumushiJump, isSuzumushiJump;
	
	private Sound  A1_04_harp ,A1_05_7_kirigilis_long,A1_05_7_kirigilis_voice ,A1_05_8_tentoumushi_voice,
		A1_05_9_kamakiri_voice ,A1_05_10_tonbo_voice ,A1_05_11_cyou_voice, A1_05_12_hachi_voice ,
		A1_05_13_semi ,A1_05_13_semi_voice ,A1_05_14_ari_voice ,A1_05_15_dangomushi_voice ,A1_05_16_kamikirimushi ,
		A1_05_16_kamikirimushi_voice, A1_05_17_koganemushi_voice ,A1_05_18_youtyu_voice,A1_05_19_hotaru_voice ,
		A1_05_20_matsumushi, A1_05_20_matsumushi_voice ,A1_05_21_suzumushi ,A1_05_21_suzumushi_voice,
		A1_05_22_kuwagatamushi_voice, A1_05_23_kabutomushi_voice , A1_05_za, A1_06_syu2,A1_07_kirigi_byon, 
		A1_08_pomi , A1_09_kamakiri, A1_medamaya1_10_powanaki, A1_11_basa ,A1_12_bun , A1_13_kasakasa,
		A1_15_dangomushi, A1_17_18_kasa2, A1_19_kira5 , A1_20_matsumushi, A1_21_suzumushi , A1_22_23_kuwagata;

	private float arrPointtentoumushi[][] = {{ 10,80,80,10,10 },{ 10,100,360,360,10} };
	
	private float arrPointTree[][] = {{ 620,960,960,900,900,800,810,665,620 },
	...
	public void onCreateResources() {
		...
		BitmapTextureAtlasTextureRegionFactory.setAssetBasePath("mushinokoe/gfx/");
		
		mTexturePackLoaderFromSource = new TexturePackLoaderFromSource(this.getTextureManager(),
				pAssetManager, "mushinokoe/gfx/");
	...
	protected void loadKaraokeResources() {
		...
		//BackGround
		//Trua
		this.ttrBackGround1 = ttpLibMushinokoe1.get(Vol3MushinokoeResource.A1_04_1_1_IPHONE_HAIKEI_HIRU_ID);
		
		//Toi
		this.ttrBackGround2 = ttpLibMushinokoe1.get(Vol3MushinokoeResource.A1_04_2_IPHONE_HAIKEI_YORU_ID);
		
		//Sang
		this.ttrBackGround3 = ttpLibMushinokoe1.get(Vol3MushinokoeResource.A1_04_3_IPHONE_HAIKEI_ASA_ID);
		
		//back ground
		this.ttrBackGround4 = ttpLibMushinokoe5.get(Vol3MushinokoeResource.A1_04_1_2_IPHONE_HAIKEI_HIRU_ID);
		
		//Mushikago
		this.ttrMushikago = ttpLibMushinokoe5.get(Vol3MushinokoeResource.A1_05_1_IPHONE_MUSHIKAGO_ID);
		...
		this.ttrnameOneKuwagata = ttpLibMushinokoe4.get(Vol3MushinokoeResource.A1_22_3_IPHONE_KUWAGATA_ID);
		this.ttrOneKuwagata4 = ttpLibMushinokoe4.get(Vol3MushinokoeResource.A1_22_4_IPHONE_KUWAGATA_ID);
		this.ttrOneKuwagata5 = ttpLibMushinokoe4.get(Vol3MushinokoeResource.A1_22_5_IPHONE_KUWAGATA_ID);
		//Kabuto
		...
		this.ttrnameOneKabuto = ttpLibMushinokoe4.get(Vol3MushinokoeResource.A1_23_3_IPHONE_KABUTO_ID);
		this.ttrOneKabuto4 = ttpLibMushinokoe4.get(Vol3MushinokoeResource.A1_23_4_IPHONE_KABUTO_ID);
		this.ttrOneKabuto5 = ttpLibMushinokoe4.get(Vol3MushinokoeResource.A1_23_5_IPHONE_KABUTO_ID);
		//Sau buoi trua
		//Kamakiri
		this.ttrKamakiri1 = ttpLibMushinokoe2.get(Vol3MushinokoeResource.A1_09_1_IPHONE_KAMAKIRI_ID);
		this.ttrKamakiri2 = ttpLibMushinokoe2.get(Vol3MushinokoeResource.A1_09_A_IPHONE_KAMAKIRI_ID);
		this.ttrKamakiri3 = ttpLibMushinokoe2.get(Vol3MushinokoeResource.A1_09_B_IPHONE_KAMAKIRI_ID);
		
		this.ttrnameKamakiri = ttpLibMushinokoe2.get(Vol3MushinokoeResource.A1_09_4_IPHONE_KAMAKIRI_ID);
		
		this.ttrKamakiri5 = ttpLibMushinokoe2.get(Vol3MushinokoeResource.A1_09_5_IPHONE_KAMAKIRI_ID);
		...
		this.ttrKirigirisu = ttpLibMushinokoe2.get(Vol3MushinokoeResource.A1_07_4_IPHONE_KIRIGIRISU_ID);
		
		this.ttrnameKirigirisu = ttpLibMushinokoe2.get(Vol3MushinokoeResource.A1_07_5_IPHONE_KIRIGIRISU_ID);
		this.ttrKirigirisu6 = ttpLibMushinokoe2.get(Vol3MushinokoeResource.A1_07_6_IPHONE_KIRIGIRISU_ID);
		...
		this.ttrnameTentoumushi = ttpLibMushinokoe2.get(Vol3MushinokoeResource.A1_08_3_IPHONE_TENTOUMUSHI_ID);
		
		this.ttrTentoumushi4 = ttpLibMushinokoe2.get(Vol3MushinokoeResource.A1_08_4_IPHONE_TENTOUMUSHI_ID);
		...
		this.ttrTonbo3 = ttpLibMushinokoe2.get(Vol3MushinokoeResource.A1_10_3_IPHONE_TONBO_ID);
		this.ttrnameTonbo = ttpLibMushinokoe2.get(Vol3MushinokoeResource.A1_10_4_IPHONE_TONBO_ID);
		this.ttrTonbo5 = ttpLibMushinokoe2.get(Vol3MushinokoeResource.A1_10_5_IPHONE_TONBO_ID);
		
		//Cyou
		this.ttrCyou1 = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_11_1_IPHONE_CYOU_ID);
		...
		this.ttrnameCyou = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_11_4_IPHONE_CYOU_ID);
		this.ttrCyou5 = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_11_5_IPHONE_CYOU_ID);
		this.ttrCyou6 = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_11_6_IPHONE_CYOU_ID);
		
		//Hachi
		this.ttrHachi1 = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_12_1_IPHONE_HACHI_ID);
		this.ttrHachi2 = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_12_2_IPHONE_HACHI_ID);
		this.ttrHachi3 = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_12_2_1_IPHONE_HACHI_ID);
		this.ttrHachi4 = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_12_3_IPHONE_HACHI_ID);
		this.ttrHachi5 = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_12_4_IPHONE_HACHI_ID);
		this.ttrnameHachi = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_12_6_IPHONE_HACHI_ID);
		this.ttrHachi7 = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_12_7_IPHONE_HACHI_ID);
		
		//Semi
		this.ttrSemi1 = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_13_1_IPHONE_SEMI_ID);
		this.ttrSemi2 = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_13_2_IPHONE_SEMI_ID);
		this.ttrSemi3 = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_13_3_IPHONE_SEMI_ID);
		this.ttrnameSemi = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_13_4_IPHONE_SEMI_ID);
		this.ttrSemi5 = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_13_5_IPHONE_SEMI_ID);
		this.ttrSemi6 = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_13_6_IPHONE_SEMI_ID);
		...
		this.ttrnameAri = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_14_4_IPHONE_ARI_ID);
		
		this.ttrAri5 = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_14_5_IPHONE_ARI_ID);
		...
		this.ttrnameDango = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_15_4_IPHONE_DANGO_ID);
		this.ttrDango5 = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_15_5_IPHONE_DANGO_ID);
		...
		this.ttrnameKamikiri = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_16_3_IPHONE_KAMIKIRI_ID);
		this.ttrKamikiri4 = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_16_4_IPHONE_KAMIKIRI_ID);
		...
		this.ttrnameKogane = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_17_4_IPHONE_KOGANE_ID);
		this.ttrKogane5 = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_17_5_IPHONE_KOGANE_ID);
		...
		this.ttrnameYoutyu = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_18_5_IPHONE_YOUTYU_ID);
		this.ttrYoutyu6 = ttpLibMushinokoe3.get(Vol3MushinokoeResource.A1_18_6_IPHONE_YOUTYU_ID);
		
		//Sau buoi toi
		//Hotaru
		this.ttrHotaru1 = ttpLibMushinokoe4.get(Vol3MushinokoeResource.A1_19_1_IPHONE_HOTARU_ID);
		this.ttrHotaru2 = ttpLibMushinokoe4.get(Vol3MushinokoeResource.A1_19_2_IPHONE_HOTARU_ID);
		this.ttrHotaru3 = ttpLibMushinokoe4.get(Vol3MushinokoeResource.A1_19_3_IPHONE_HOT_ID);
		this.ttrnameHotaru = ttpLibMushinokoe4.get(Vol3MushinokoeResource.A1_19_4_IPHONE_HOTARU_ID);
		this.ttrHotaru5 = ttpLibMushinokoe4.get(Vol3MushinokoeResource.A1_19_5_IPHONE_HOTARU_ID);
		
		//Matsumushi
		this.ttrMatsumushi1 = ttpLibMushinokoe4.get(Vol3MushinokoeResource.A1_20_1_IPHONE_MATSUMUSHI_ID);
		...
		this.ttrnameMatsumushi = ttpLibMushinokoe4.get(Vol3MushinokoeResource.A1_20_4_IPHONE_MATSUMUSHI_ID);
		this.ttrMatsumuchi5 = ttpLibMushinokoe4.get(Vol3MushinokoeResource.A1_20_5_IPHONE_MATSUMUSHI_ID);
		
		//Suzumushi
		this.ttrSuzumushi1 = ttpLibMushinokoe4.get(Vol3MushinokoeResource.A1_21_1_IPHONE_SUZUMUSHI_ID);
		...
		this.ttrnameSuzumushi = ttpLibMushinokoe4.get(Vol3MushinokoeResource.A1_21_4_IPHONE_SUZUMUSHI_ID);
		this.ttrSuzumushi5 = ttpLibMushinokoe4.get(Vol3MushinokoeResource.A1_21_5_IPHONE_SUZUMUSHI_ID);
		
		//Hake
		this.ttrHake1 = ttpLibMushinokoe4.get(Vol3MushinokoeResource.A1_06_1_IPHONE_HAKE_ID);
		this.ttrHake2 = ttpLibMushinokoe4.get(Vol3MushinokoeResource.A1_06_2_IPHONE_HAKE_ID);
		this.ttrHake3 = ttpLibMushinokoe4.get(Vol3MushinokoeResource.A1_06_3_IPHONE_HAKE_ID);
		
		//Ami
		this.ttrAmi = ttpLibMushinokoe5.get(Vol3MushinokoeResource.A1_05_2_IPHONE_AMI_ID);
	...
	protected void loadKaraokeScene() {
		...
		//Toi
		sBackGround2 = new Sprite(-999, -999, ttrBackGround2, this.getVertexBufferObjectManager());
		...
		//Kamariki
		this.sKamakiri1 = new Sprite(-999, -999, ttrKamakiri1, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sKamakiri1);
		
		this.sKamakiri2 = new Sprite(155, 82, ttrKamakiri2, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sKamakiri2);
		sKamakiri2.setVisible(false);
		
		this.sKamakiri3 = new Sprite(155, 82, ttrKamakiri3, this.getVertexBufferObjectManager());
		...
		//Ari
		this.animAri = new AnimatedSprite(-999, -999, tttrAri, this.getVertexBufferObjectManager());
		this.mScene.attachChild(animAri);
		
		//Dango
		this.animDango = new AnimatedSprite(-999, -999, tttrDango, this.getVertexBufferObjectManager());
		this.mScene.attachChild(animDango);
		
		//Mushikago
		sMushikago = new Sprite(222, 250, ttrMushikago, this.getVertexBufferObjectManager());
		mScene.attachChild(sMushikago);
		sMushikago.setVisible(true);
		
		//Hake3
		sHake3 = new Sprite(761, 193, ttrHake3, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sHake3);
		sHake3.setVisible(false);

		//Sau buoi sang
		//anim Kawagata
		this.animKuwagata = new AnimatedSprite(-999, -999, tttrKuwagata, this.getVertexBufferObjectManager());
		this.mScene.attachChild(animKuwagata);
		
		this.sOneKugawata5 = new Sprite(325, 371, ttrOneKuwagata5, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sOneKugawata5);
		sOneKugawata5.setVisible(false);
		
		this.sOneKugawata4 = new Sprite(-999, -999, ttrOneKuwagata4, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sOneKugawata4);
		
		//anim Kabuto
		this.animKabuto = new AnimatedSprite(-999, -999, tttrKabuto, this.getVertexBufferObjectManager());
		this.mScene.attachChild(animKabuto);
		
		this.sOneKabuto5 = new Sprite(325, 371, ttrOneKabuto5, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sOneKabuto5);
		sOneKabuto5.setVisible(false);
		
		this.sOneKabuto4 = new Sprite(-999, -999, ttrOneKabuto4, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sOneKabuto4);

		//Sau buoi trua
		//Kamakiri name
		
		this.sKamakiri5 = new Sprite(-999, -999, ttrKamakiri5, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sKamakiri5);
		
		//sKirigirisu
		this.sKirigirisu6 = new Sprite(-999, -999, ttrKirigirisu6, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sKirigirisu6);
		
		this.animKirigirisu = new AnimatedSprite(-999, -999, tttrKirigirisu, this.getVertexBufferObjectManager());
		this.mScene.attachChild(animKirigirisu);
		
		this.sKirigirisu = new Sprite(-59, 428, ttrKirigirisu, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sKirigirisu);
		sKirigirisu.setVisible(false);
		
		//Tentoumushi
		this.animTentoumushi = new AnimatedSprite(-999, -999, tttrTentoumushi, this.getVertexBufferObjectManager());
		this.mScene.attachChild(animTentoumushi);
		
		this.sTentoumushi4 = new Sprite(-999, -999, ttrTentoumushi4, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sTentoumushi4);
		
		//Tonbo
		this.animTonbo = new AnimatedSprite(-999, -999, tttrTonbo, this.getVertexBufferObjectManager());
		this.mScene.attachChild(animTonbo);
		
		this.sTonbo3 = new Sprite(162, 0, ttrTonbo3, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sTonbo3);
		sTonbo3.setVisible(false);
		
		this.sTonbo5 = new Sprite(-999, -999, ttrTonbo5, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sTonbo5);
		
		//Semi
		this.sSemi1 = new Sprite(-999, -999, ttrSemi1, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sSemi1);
		
		this.sSemi2 = new Sprite(649, 74, ttrSemi2, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sSemi2);
		sSemi2.setVisible(false);
		
		this.sSemi6 = new Sprite(325, 371, ttrSemi6	, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sSemi6);
		sSemi6.setVisible(false);
		
		this.sSemi5 = new Sprite(-999, -999, ttrSemi5, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sSemi5);
		
		//Cyou
		this.sCyou1 = new Sprite(-999, -999, ttrCyou1, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sCyou1);
		
		this.sCyou6 = new Sprite(325, 371, ttrCyou6, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sCyou6);
		sCyou6.setVisible(false);
		
		this.sCyou5 = new Sprite(-999, -999, ttrCyou5, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sCyou5);
				
		//Ari name
		this.sAri5 = new Sprite(-999, -999, ttrAri5, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sAri5);
		
		//Hachi
		this.sHachi1 = new Sprite(-999, -999, ttrHachi1, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sHachi1);
		
		this.sHachi2 = new Sprite(580, 17, ttrHachi2, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sHachi2);
		sHachi2.setVisible(false);
		
		this.sHachi3 = new Sprite(580, 17, ttrHachi3, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sHachi3);
		sHachi3.setVisible(false);
		
		this.sHachi7 = new Sprite(-999, -999, ttrHachi7, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sHachi7);
		
		//Dango name
		
		this.sDango5 = new Sprite(-999, -999, ttrDango5, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sDango5);
		
		//Kamikiri
		this.animKamikiri = new AnimatedSprite(-999, -999, tttrKamikiri, this.getVertexBufferObjectManager());
		this.mScene.attachChild(animKamikiri);
		
		this.sKamikiri4 = new Sprite(-999, -999, ttrKamikiri4, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sKamikiri4);
		
		//Kogane
		this.animKogane = new AnimatedSprite(-999, -999, tttrKogane, this.getVertexBufferObjectManager());
		this.mScene.attachChild(animKogane);
		
		this.sKogane5 = new Sprite(-999, -999, ttrKogane5, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sKogane5);
		
		//Youtyu
		this.animYoutyu = new AnimatedSprite(-999, -999, tttrYoutyu, this.getVertexBufferObjectManager());
		this.mScene.attachChild(animYoutyu);
		
		this.sYoutyu6 = new Sprite(-999, -999, ttrYoutyu6, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sYoutyu6);
		
		//Sau buoi toi
		//Hotaru
		sHotaru1 = new Sprite(-999, -999, ttrHotaru1, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sHotaru1);

		sHotaru2 = new Sprite(87, 507, ttrHotaru2, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sHotaru2);
		sHotaru2.setVisible(false);
		
		sHotaru3 = new Sprite(0, 0, ttrHotaru3, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sHotaru3);
		sHotaru3.setVisible(false);
		
		sHotaru5 = new Sprite(-999, -999, ttrHotaru5, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sHotaru5);
		
		//Matsumushi
		
		sMatsumushi1 = new Sprite(-999, -999, ttrMatsumushi1, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sMatsumushi1);
		
		animMatsumushi = new AnimatedSprite(141, 391, tttrMatsumushi, this.getVertexBufferObjectManager());
		this.mScene.attachChild(animMatsumushi);
		animMatsumushi.setVisible(false);
		
		sMatsumushi5 = new Sprite(-999, -999, ttrMatsumuchi5, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sMatsumushi5);
		
		//Suzumushi
		sSuzumushi1 = new Sprite(-999, -999, ttrSuzumushi1, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sSuzumushi1);
		
		animSuzumushi = new AnimatedSprite(54, 361, tttrSuzumushi, this.getVertexBufferObjectManager());
		this.mScene.attachChild(animSuzumushi);
		animSuzumushi.setVisible(false);

		sSuzumushi5 =new Sprite(-999, -999, ttrSuzumushi5, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sSuzumushi5);
		
		//Hake
		sHake1 = new Sprite(-999, -999, ttrHake1, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sHake1);
		sHake2 = new Sprite(761, 193, ttrHake2, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sHake2);
		sHake2.setVisible(false);
		
		
		//Name
		this.snameOneKugawata = new Sprite(344, 300, ttrnameOneKuwagata, this.getVertexBufferObjectManager());
		this.mScene.attachChild(snameOneKugawata);
		snameOneKugawata.setVisible(false);
		
		this.snameKamakiri = new Sprite(344, 300, ttrnameKamakiri, this.getVertexBufferObjectManager());
		this.mScene.attachChild(snameKamakiri);
		snameKamakiri.setVisible(false);
		
		this.snameOneKabuto = new Sprite(344, 300, ttrnameOneKabuto, this.getVertexBufferObjectManager());
		this.mScene.attachChild(snameOneKabuto);
		snameOneKabuto.setVisible(false);
		
		this.snameKirigirisu = new Sprite(344, 300, ttrnameKirigirisu, this.getVertexBufferObjectManager());
		this.mScene.attachChild(snameKirigirisu);
		snameKirigirisu.setVisible(false);
		
		this.snameTentoumushi = new Sprite(344, 300, ttrnameTentoumushi, this.getVertexBufferObjectManager());
		this.mScene.attachChild(snameTentoumushi);
		snameTentoumushi.setVisible(false);
		
		this.snameTonbo = new Sprite(344, 300, ttrnameTonbo, this.getVertexBufferObjectManager());
		this.mScene.attachChild(snameTonbo);
		snameTonbo.setVisible(false);
		
		this.snameSemi = new Sprite(344, 300, ttrnameSemi, this.getVertexBufferObjectManager());
		this.mScene.attachChild(snameSemi);
		snameSemi.setVisible(false);
		
		this.snameCyou = new Sprite(344, 300, ttrnameCyou, this.getVertexBufferObjectManager());
		this.mScene.attachChild(snameCyou);
		snameCyou.setVisible(false);
		
		this.snameAri = new Sprite(344, 300, ttrnameAri, this.getVertexBufferObjectManager());
		this.mScene.attachChild(snameAri);
		snameAri.setVisible(false);
		
		this.snameHachi = new Sprite(344, 300, ttrnameHachi, this.getVertexBufferObjectManager());
		this.mScene.attachChild(snameHachi);
		snameHachi.setVisible(false);
		
		this.snameDango = new Sprite(344, 300, ttrnameDango, this.getVertexBufferObjectManager());
		this.mScene.attachChild(snameDango);
		snameDango.setVisible(false);
		
		this.snameKamikiri = new Sprite(344, 300, ttrnameKamikiri, this.getVertexBufferObjectManager());
		this.mScene.attachChild(snameKamikiri);
		snameKamikiri.setVisible(false);
		
		this.snameKogane = new Sprite(344, 300, ttrnameKogane, this.getVertexBufferObjectManager());
		this.mScene.attachChild(snameKogane);
		snameKogane.setVisible(false);
		
		this.snameYoutyu = new Sprite(344, 300, ttrnameYoutyu, this.getVertexBufferObjectManager());
		this.mScene.attachChild(snameYoutyu);
		snameYoutyu.setVisible(false);
		
		snameHotaru = new Sprite(344, 300, ttrnameHotaru, this.getVertexBufferObjectManager());
		this.mScene.attachChild(snameHotaru);
		snameHotaru.setVisible(false);
		
		snameMatsumushi = new Sprite(344, 300, ttrnameMatsumushi, this.getVertexBufferObjectManager());
		this.mScene.attachChild(snameMatsumushi);
		snameMatsumushi.setVisible(false);
		
		snameSuzumushi = new Sprite(344, 300, ttrnameSuzumushi, this.getVertexBufferObjectManager());
		...
		// Hachi Fly
		this.sHachi4 = new Sprite(-999, -999, ttrHachi4, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sHachi4);
		
		this.sHachi5 = new Sprite(-999, -999, ttrHachi5, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sHachi5);
		
		this.sSemi3 = new Sprite(-999, -999, ttrSemi3, this.getVertexBufferObjectManager());
		this.mScene.attachChild(sSemi3);
		
		//Cyou fly
		this.animCyou = new AnimatedSprite(-999, -999, tttrCyou, this.getVertexBufferObjectManager());
		this.mScene.attachChild(animCyou);
		
		//Shape Ami
		shapeAmi = new Rectangle(40, 40, 1, 1, this.getVertexBufferObjectManager());
		shapeAmi.setAlpha((float) 0.0);
		sAmi.attachChild(shapeAmi);
		
		//Shape Kuwagata
		shapeKuwagata = new Rectangle(20, 20, 50, 60, this.getVertexBufferObjectManager());
		shapeKuwagata.setAlpha((float) 0.0);
		animKuwagata.attachChild(shapeKuwagata);
		
		//Shape Kabuto
		shapeKabuto = new Rectangle(25, 40, 35, 50, this.getVertexBufferObjectManager());
		shapeKabuto.setAlpha((float) 0.0);
		animKabuto.attachChild(shapeKabuto);
		
		//Shape Kirigirisu
		shapeKirigirisu = new Rectangle(155, 80, 75, 85, this.getVertexBufferObjectManager());
		shapeKirigirisu.setAlpha((float) 0.0);
		animKirigirisu.attachChild(shapeKirigirisu);
		
		////Shape Tentoumushi
		shapeTentoumushi= new Rectangle(15, 65, 75, 235, this.getVertexBufferObjectManager());
		shapeTentoumushi.setAlpha((float) 0.0);
		animTentoumushi.attachChild(shapeTentoumushi);
		
		//Shape Kamakiri
		shapeKamakiri = new Rectangle(60, 55, 60, 160, this.getVertexBufferObjectManager());
		shapeKamakiri.setAlpha((float) 0.0);
		sKamakiri1.attachChild(shapeKamakiri);
		
		//Shape Tonbo
		shapeTonbo = new Rectangle(50, 30, 90, 60, this.getVertexBufferObjectManager());
		shapeTonbo.setAlpha((float) 0.0);
		animTonbo.attachChild(shapeTonbo);
		
		//Shape Cyou
		shapeCyou1 = new Rectangle(25, 25, 35, 65, this.getVertexBufferObjectManager());
		shapeCyou1.setAlpha((float) 0.0);
		sCyou1.attachChild(shapeCyou1);
		
		shapeCyou2 = new Rectangle(25, 30, 35, 45, this.getVertexBufferObjectManager());
		shapeCyou2.setAlpha((float) 0.0);
		animCyou.attachChild(shapeCyou2);
		
		//Shape Hachi
		shapeHachi1 = new Rectangle(110, 30, 40, 40, this.getVertexBufferObjectManager());
		shapeHachi1.setAlpha((float) 0.0);
		sHachi1.attachChild(shapeHachi1);
		
		shapeHachi2 = new Rectangle(25, 25, 40, 25, this.getVertexBufferObjectManager());
		shapeHachi2.setAlpha((float) 0.0);
		sHachi4.attachChild(shapeHachi2);
		
		shapeHachi3 = new Rectangle(20, 20, 40, 30, this.getVertexBufferObjectManager());
		shapeHachi3.setAlpha((float) 0.0);
		sHachi5.attachChild(shapeHachi3);
		
		//Shape Semi
		shapeSemi1 = new Rectangle(145, 50, 35, 100, this.getVertexBufferObjectManager());
		shapeSemi1.setAlpha((float) 0.0);
		sSemi1.attachChild(shapeSemi1);
		
		shapeSemi2 = new Rectangle(25, 55, 60, 45, this.getVertexBufferObjectManager());
		shapeSemi2.setAlpha((float) 0.0);
		sSemi3.attachChild(shapeSemi2);
		
		//Shape Ari
		shapeAri = new Rectangle(42, 42, 80, 60, this.getVertexBufferObjectManager());
		shapeAri.setAlpha((float) 0.0);
		animAri.attachChild(shapeAri);
		
		//Shape Dango
		shapeDango =  new Rectangle(40, 50, 73, 47, this.getVertexBufferObjectManager());
		shapeDango.setAlpha((float) 0.0);
		animDango.attachChild(shapeDango);
		
		//Shape Kamikiri
		shapeKamikiri = new Rectangle(20, 60, 35, 60, this.getVertexBufferObjectManager());
		shapeKamikiri.setAlpha((float) 0.0);
		animKamikiri.attachChild(shapeKamikiri);
		
		//Kogane
		shapeKogane = new Rectangle(40, 55, 50, 40, this.getVertexBufferObjectManager());
		shapeKogane.setAlpha((float) 0.0);
		animKogane.attachChild(shapeKogane);
		
		//Youtyu
		shapeYoutyu =  new Rectangle(60, 35, 70, 45, this.getVertexBufferObjectManager());
		shapeYoutyu.setAlpha((float) 0.0);
		animYoutyu.attachChild(shapeYoutyu);
		
		//Hotaru
		shapeHotaru = new Rectangle(40, 40, 65, 40, this.getVertexBufferObjectManager());
		shapeHotaru.setAlpha((float) 0.0);
		sHotaru1.attachChild(shapeHotaru);
		
		//Matsumushi
		shapeMatsumushi = new Rectangle(30, 60, 70, 35, this.getVertexBufferObjectManager());
		shapeMatsumushi.setAlpha((float) 0.0);
		sMatsumushi1.attachChild(shapeMatsumushi);
		
		//Suzumushi
		shapeSuzumushi = new Rectangle(19, 57, 61, 43, this.getVertexBufferObjectManager());
		shapeSuzumushi.setAlpha((float) 0.0);
		sSuzumushi1.attachChild(shapeSuzumushi);
		
		addGimmicsButton(mScene, Vol3MushinokoeResource.SOUND_GIMMIC_MUSHINOKOE,
			Vol3MushinokoeResource.IMAGE_GIMMIC_MUSHINOKOE, ttpLibMushinokoe5);
	...
	public synchronized void onResumeGame() {
		...
		//Sang
		if(3 <= hours && hours <= 7) cases = 3;
		//Trua
		if(8 <= hours && hours <= 17) cases = 1;
		//Toi
		if(18 <= hours && hours <= 23) cases = 2;
		if(0 <= hours && hours <= 2) cases = 2;
	...
	public boolean onSceneTouchEvent(Scene pScene, TouchEvent pSceneTouchEvent) {
		...
		if(pSceneTouchEvent.isActionDown()){
			...
			// touch tentoumushi
			if(checkContainsPolygon(animTentoumushi, arrPointtentoumushi, 5, pX, pY)){
			...
			//touch Kuwagata
			if(animKuwagata.contains(pX, pY) && isTouchKuwagata && !isFaceKuwagata){
			...
			//touch Kirigirisu
			if(checkContains(animKirigirisu, 130, 70, 250, 185, pX, pY) && isTouchKirigirisu){
				enableCatch = false;
			...
			//touch Kamakiri
			if(checkContains(sKamakiri1, 70, 30, 160, 215, pX, pY) && isTouchKamakiri){
			...
			//touchKamakiri
			if(checkContains(sKamakiri1, 0, 145, 60, 290, pX, pY) && isTouchKamakiri){
				Log.d(TAG, "Touch Kamakiri");
				isTouchKamakiri = false;
			...
			//touch Tonbo
			if(checkContains(animTonbo, 22, 3, 193, 102, pX, pY) && isTouchTonbo){
			...
			//touch Kamikiri
			if(checkContains(animKamikiri, 4, 49, 64, 125, pX, pY) && isTouchKamikiri){
				enableCatch = false;
			...
			//touchHotaru
			if(checkContains(sHotaru1, 44, 16, 124, 82, pX, pY) && isTouchHotaru){
			...
			//touchMatsumushi
			if(checkContains(sMatsumushi1, 10, 28, 134, 98, pX, pY) && isTouchMatsumushi){
			...
			//touchSuzumushi
			if(checkContains(sSuzumushi1, 4, 38, 114, 107, pX, pY) && isTouchSuzumushi){
			...
			//touchHake
			if(checkContains(sHake1, 16, 95, 67, 164, pX, pY) || checkContainsPolygon(sBackGround2, arrPointTree, 9, pX, pY) && isTouchHake){
			...
			if(checkContains(sOneKabuto4, 39, 35, 244, 179, pX, pY)){
				if(isKabutoJump){
					...
					sOneKabuto4.registerEntityModifier(new DelayModifier(1.1f, new IEntityModifierListener() {
						@Override
			...
			if(checkContains(sOneKugawata4, 36, 48, 244, 175, pX, pY)){
				if(isKuwagataJump){
					...
					sOneKugawata4.registerEntityModifier(new DelayModifier(1.1f, new IEntityModifierListener() {
						@Override
						public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
			...
			if(checkContains(sKirigirisu6, 37, 45, 279, 188, pX, pY)){
				if(isKirigirisuJump){
					...
					sKirigirisu6.registerEntityModifier(new DelayModifier(1.1f, new IEntityModifierListener() {
						@Override
						public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
			...
			if(checkContains(sTentoumushi4, 44, 99, 251, 180, pX, pY)){
				if(isTentoumushiJump){
					...
					sTentoumushi4.registerEntityModifier(new DelayModifier(1.1f, new IEntityModifierListener() {
						@Override
						public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
			...
			if(checkContains(sKamakiri5, 3, 61, 296, 195, pX, pY)){
				if(isKamakiriJump){
					...
					sKamakiri5.registerEntityModifier(new DelayModifier(1.1f, new IEntityModifierListener() {
						@Override
						public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
			...
			if(checkContains(sTonbo5, 33, 57, 261, 194, pX, pY)){
				if(isTonboJump){
					...
					isTonboJump = false;
					actionJump(sTonbo5);
					sTonbo5.registerEntityModifier(new DelayModifier(1.1f, new IEntityModifierListener() {
						@Override
						public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
			...
			if(checkContains(sCyou5, 73, 13, 263, 194, pX, pY)){
				if(isCyouJump){
					...
					isCyouJump = false;
					actionJump(sCyou5);
					sCyou5.registerEntityModifier(new DelayModifier(1.1f, new IEntityModifierListener() {
			...
			if(checkContains(sHachi7, 47, 62, 264, 183, pX, pY)){
				if(isHachiJump){
					...
					actionJump(sHachi7);
					sHachi7.registerEntityModifier(new DelayModifier(1.1f, new IEntityModifierListener() {
						@Override
						public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
			...
			if(checkContains(sSemi5, 75, 31, 201, 168, pX, pY)){
				if(isSemiJump){
					...
					isSemiJump = false;
					actionJump(sSemi5);
					sSemi5.registerEntityModifier(new DelayModifier(1.1f, new IEntityModifierListener() {
						@Override
						public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
			...
			if(checkContains(sAri5, 39, 95, 252, 186, pX, pY)){
				if(isAriJump){
					...
					isAriJump = false;
					actionJump(sAri5);
					sAri5.registerEntityModifier(new DelayModifier(1.1f, new IEntityModifierListener() {
						@Override
						public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
			...
			if(checkContains(sDango5, 73, 100, 243, 179, pX, pY)){
				if(isDangoJump){
					...
					isDangoJump = false;
					actionJump(sDango5);
					sDango5.registerEntityModifier(new DelayModifier(1.1f, new IEntityModifierListener() {
						@Override
						public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
			...
			if(checkContains(sKamikiri4, 38, 114, 269, 196, pX, pY)){
				if(isKamikiriJump){
					...
					sKamikiri4.registerEntityModifier(new DelayModifier(1.1f, new IEntityModifierListener() {
						@Override
						public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
			...
			if(checkContains(sKogane5, 64, 90, 259, 192, pX, pY)){
				if(isKoganeJump){
					...
					isKoganeJump = false;
					actionJump(sKogane5);
					sKogane5.registerEntityModifier(new DelayModifier(1.1f, new IEntityModifierListener() {
						@Override
						public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
			...
			if(checkContains(sYoutyu6, 40, 100, 255, 193, pX, pY)){
				if(isYoutyuJump){
					...
					isYoutyuJump = false;
					actionJump(sYoutyu6);
					sYoutyu6.registerEntityModifier(new DelayModifier(1.1f, new IEntityModifierListener() {
						@Override
						public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
			...
			if(checkContains(sHotaru5, 27, 70, 259, 194, pX, pY)){
				if(isHotaruJump){
					...
					isHotaruJump = false;
					actionJump(sHotaru5);
					sHotaru5.registerEntityModifier(new DelayModifier(1.1f, new IEntityModifierListener() {
						@Override
						public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
			...
			if(checkContains(sMatsumushi5, 19, 83, 284, 196, pX, pY)){
				if(isMatsumushiJump){
					...
					sMatsumushi5.registerEntityModifier(new DelayModifier(1.1f, new IEntityModifierListener() {
						@Override
						public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
			...
			if(checkContains(sSuzumushi5, 58, 71, 247, 198, pX, pY)){
				if(isSuzumushiJump){
					...
					sSuzumushi5.registerEntityModifier(new DelayModifier(1.1f, new IEntityModifierListener() {
						@Override
						public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
		...
		if(pSceneTouchEvent.isActionMove()){
			if(isAmiMove){
				...
				if(shapeAmi.collidesWith(shapeKabuto) && isCatch){
					...
					visibleFalseWorm3 (snameOneKugawata, sOneKugawata4, sOneKugawata5);
				...
				if(shapeAmi.collidesWith(shapeKuwagata) && isCatch){
					...
					visibleTrueWorm3 (snameOneKugawata, sOneKugawata4, sOneKugawata5);
				...
				if(shapeAmi.collidesWith(shapeKirigirisu) && isCatch){
					...
					sKirigirisu6.registerEntityModifier(new DelayModifier(2.0f , new IEntityModifierListener() {
						@Override
						public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
				...
				if(shapeAmi.collidesWith(shapeCyou1) || shapeAmi.collidesWith(shapeCyou2) && isCatch){
					delayAmi();
					checkCyouFly = 0;
				...
				if(shapeAmi.collidesWith(shapeHachi1) || shapeAmi.collidesWith(shapeHachi2)
				...
				//Semi
				if(shapeAmi.collidesWith(shapeSemi1) || shapeAmi.collidesWith(shapeSemi2) && isCatch){
					delayAmi();
					enableCatch = false;
					isSemiJump = false;
					A1_05_13_semi.play();
					...
					sSemi5.registerEntityModifier(new DelayModifier(3.5f , new IEntityModifierListener() {
						@Override
						public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
				...
				if(shapeAmi.collidesWith(shapeKamikiri) && isCatch){
					...
					sKamikiri4.registerEntityModifier(new DelayModifier(2.0f , new IEntityModifierListener() {
						@Override
						public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
				...
				if(shapeAmi.collidesWith(shapeMatsumushi) && isCatch){
					...
					sMatsumushi5.registerEntityModifier(new DelayModifier(2.0f , new IEntityModifierListener() {
						@Override
						public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
				...
				if(shapeAmi.collidesWith(shapeSuzumushi) && isCatch){
					...
					sSuzumushi5.registerEntityModifier(new DelayModifier(3.0f , new IEntityModifierListener() {
						@Override
						public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
	...
	//Function Kirigirisu
	public void touchKirigirisu(final AnimatedSprite animSprite ,final Sprite sSprite){
		A1_07_kirigi_byon.play();
		animSprite.setCurrentTileIndex(0);
		animSprite.registerEntityModifier(new DelayModifier(0.5f , new IEntityModifierListener() {
			...
			public void onModifierFinished(IModifier<IEntity> arg0, IEntity arg1) {
				...
				animSprite.registerEntityModifier(new DelayModifier(0.5f, new IEntityModifierListener() {
					...
					public void onModifierFinished(IModifier<IEntity> arg0, IEntity arg1) {
						...
						sSprite.registerEntityModifier(new SequenceEntityModifier (new ParallelEntityModifier(
							new MoveXModifier(0.3f, -59, -180),
							new MoveYModifier(0.2f, 428, 435)
								), 
	...
	private void touchKamakiri(final Sprite s1, final Sprite s2){
		...
		s1.setVisible(false);
		s2.setVisible(true);
		s2.registerEntityModifier(new DelayModifier(1.5f , new IEntityModifierListener() {
	...
	private void touchTonbo(){
		...
		sTonbo3.registerEntityModifier(new DelayModifier(2.0f, new IEntityModifierListener() {
			@Override
			public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
	...
	private void touchCyou(){
		...
		animCyou.registerEntityModifier(new SequenceEntityModifier(
				new MoveXModifier(2.5f, 185, 960),
		...
		sHachi1.registerEntityModifier(new SequenceEntityModifier(
				...
				new DelayModifier(0.3f, new IEntityModifierListener() {
					...
					public void onModifierFinished(IModifier<IEntity> arg0, IEntity arg1) {
						...
						sHachi2.registerEntityModifier(new DelayModifier(0.5f, new IEntityModifierListener() {
							@Override
							public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
							...
							public void onModifierFinished(IModifier<IEntity> arg0, IEntity arg1) {
								...
								sHachi3.registerEntityModifier(new DelayModifier(0.1f, new IEntityModifierListener() {
									@Override
									public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
	...
	private void touchSemi(){
		checkSemi = 1;
		sSemi1.registerEntityModifier(new DelayModifier(1.0f, new IEntityModifierListener() {
			@Override
			public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
			...
			public void onModifierFinished(IModifier<IEntity> arg0, IEntity arg1) {
				...
				sSemi2.registerEntityModifier(new DelayModifier(1.0f, new IEntityModifierListener() {
					@Override
					public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
					...
					public void onModifierFinished(IModifier<IEntity> arg0, IEntity arg1) {
						...
						sSemi3.registerEntityModifier(new SequenceEntityModifier(
								new MoveModifier(2.5f, 649, -208, 74, -150), 
								new DelayModifier(0.3f, new IEntityModifierListener() {
									@Override
									public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
	...
	private void touchKamikiri (int kamikiriPoint){
		...
		if(kamikiriPoint==0){
			...
			A1_05_16_kamikirimushi.play();
			animKamikiri.registerEntityModifier(new DelayModifier(3.0f, new IEntityModifierListener() {
				@Override
				public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
	...
	public void touchHotaru(){
		...
		sHotaru3.registerEntityModifier(new SequenceEntityModifier(
			new AlphaModifier(1.3f, 0.0f, 1.0f),
			new AlphaModifier(1.3f, 1.0f, 0.0f), 
	...
	public void touchMatsumushi(){
		...
		animMatsumushi.animate(pDurationsMat, pFrameMat, 5, new IAnimationListener() {
			@Override
	...
	public void touchSuzumushi(){
		...
		animSuzumushi.animate(pDurationsSu, pFrameSu, 5, new IAnimationListener() {
			@Override
			public void onAnimationStarted(AnimatedSprite arg0, int arg1) {
	...
	public void touchHake(){
		...
		sHake2.registerEntityModifier(new DelayModifier(0.5f, new IEntityModifierListener() {
			@Override
			public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
			...
			public void onModifierFinished(IModifier<IEntity> arg0, IEntity arg1) {
				...
				sHake3.registerEntityModifier(new DelayModifier(3.0f, new IEntityModifierListener() {
					@Override
					public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
	...
	public void actionJump(Sprite sJump){
		sJump.registerEntityModifier(new SequenceEntityModifier(
			new MoveYModifier(0.3f, 371, 351),
			new MoveYModifier(0.3f, 351, 371)));
	}
	...
	public void visibleTrueMorning(){
		...
		if(notCatchKuwagata){
			animKuwagata.setPosition(801, 320);
		}else animKuwagata.setPosition(-999, -999);
		
		if(notCatchKabuto){
			animKabuto.setPosition(801, 205);
		}else animKabuto.setPosition(-999, -999);
	...
	public void visibleTrueNoon(){
		...
		if(notCatchTentoumushi){
			...
			animTentoumushi.setVisible(false);
		}else animTentoumushi.setPosition(-999, -999);
		
		if(notCatchKamakiri){
			sKamakiri1.setPosition(155, 82);
			sKamakiri2.setVisible(false);
			sKamakiri3.setVisible(false);
		}else sKamakiri1.setPosition(-999, -999);
		
		if(notCatchTonbo){
			animTonbo.setPosition(162, 0);
			animationTonbo(animTonbo);
		}else animTonbo.setPosition(-999, -999);
		...
		}else sHachi1.setPosition(-999, -999);
		
		if(notCatchSemi){
			sSemi1.setPosition(649, 74);
		}else sSemi1.setPosition(-999, -999);
		
		if(notCatchAri){
			animAri.setPosition(400, 180);
			animAri.setRotation(25);
			animAri.setCurrentTileIndex(0);
		}else animAri.setPosition(-999, -999);
		
		if(notCatchDango){
			animDango.setPosition(665, 270);
			animDango.setCurrentTileIndex(0);
		}else animDango.setPosition(-999, -999);
		
		if(notCatchKamikiri){
			animKamikiri.setPosition(810, 300);
			animKamikiri.setCurrentTileIndex(0);
		}else animKamikiri.setPosition(-999, -999);
		
		if(notCatchKogane){
			animKogane.setPosition(674,387);
			animKogane.setCurrentTileIndex(0);
		}else animKogane.setPosition(-999, -999);
		
		if(notCatchYoutyu){
			animYoutyu.setPosition(754, 530);
			animYoutyu.setCurrentTileIndex(0);
		}else animYoutyu.setPosition(-999, -999);
	...
	private void visibleTrueNight(){
		...
		}else sHotaru1.setPosition(-999,-999);
		
		if(notCatchMatsumushi){
			sMatsumushi1.setPosition(141, 391);
		}else sMatsumushi1.setPosition(-999, -999);
		
		if(notCatchSuzumushi){
			sSuzumushi1.setPosition(54, 361);
		}else sSuzumushi1.setPosition(-999, -999);
	...
	private void flyHachi1(Sprite flyHachi1){
		...
		flyHachi1.registerEntityModifier(new SequenceEntityModifier(
				...
				new MoveModifier(1.0f, pointOne11, pointOne12, pointTwo11, pointTwo12),
	...
	private void flyHachi2(Sprite flyHachi2){
		...
		flyHachi2.registerEntityModifier(new SequenceEntityModifier(
				...
				new MoveModifier(1.0f, pointOne21, pointOne22, pointTwo21, pointTwo22),
				new DelayModifier(0.5f, new IEntityModifierListener() {
					@Override
					public void onModifierStarted(IModifier<IEntity> arg0, IEntity arg1) {
	...
	@Override
	public void onAnimationFrameChanged(AnimatedSprite pAnimatedSprite, int p1, int p2) {
		
	}

	@Override
	public void onAnimationLoopFinished(AnimatedSprite pAnimatedSprite, int p1, int p2) {
